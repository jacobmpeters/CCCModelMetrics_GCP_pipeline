...
cat("Particiapnts with Module 1 Completion:", dim(module1)[[1]])
...
module1$D_205553981 <- as.Date(module1$D_205553981)
module1$DOB <- paste0(str_sub(module1$D_371067537, 1,4), "-", str_sub(module1$D_371067537, 5,6), "-", str_sub(module1$D_371067537, 7,8))
module1$DOB <- as.Date(module1$DOB)
module1$calculated <- round(lubridate::time_length(difftime(module1$D_205553981, module1$DOB), "years"), digits=3)
...
```{r Age_cont, warning=FALSE, echo=FALSE, message=FALSE}
...
#Appearance/Style
levels=c("Very Feminine", "Mostly Feminine", "Somewhat Feminine", "Equally feminine and masculine", "Very masculine", "Mostly Masculine", "Somewhat Masculine", "Skipped this question")
...
##Overall <--- come back to this one
# dict <- c(dict,"138752522"="Poor","131550264"="Fair","719933364"="Good", "565881164"="Very Good","670680466"="Excellent")
...
#Scale
#dict <- list(dict, "988858078" = "1","156095877" = "2","162668459" = "3","278139969" = "4", "676824724" = "5", "512144428" = "6", "125674414" = "7", "406650257" = "8", "700080862" = "9", "616621065" = "10")
...
#Affected Work?
# levels=c("Not At All", "A Little Bit","A Lot", "Skipped this question")
# one_logic_funct(D_338924834, D_323512813, "353358909", "PAIN3: Pain Affected Work")
...
#Female
# dict <- list(dict, "927925620" = "(0)No hair loss", "552278254"= "(1) Mild Loss on Sides", "267104669"= "(2) Mild Loss on Top", "619337179"= "(3) Mild to Moderate",
#              "601381820"= "(4) Moderate Loss on Top", "151394571"= "(5) Severe Loss on Top", "917379905"= "(6) Severe Loss and Thinning", 
#              "746328729"= "(7) Severe Loss Top and Forehead", "452963767"= "(8) All over Loss")
...
tmpM2 <- tmpMC2 %>%  select(D_814510313_D_814510313_D_939782495, D_814510313_D_814510313_D_135725957, D_814510313_D_814510313_D_518416174, D_814510313_D_814510313_D_847945207,
                    D_814510313_D_814510313_D_283025574, D_814510313_D_814510313_D_942970912, D_814510313_D_814510313_D_596122041, D_814510313_D_814510313_D_489400183,
                    D_814510313_D_814510313_D_863246236, D_814510313_D_814510313_D_607793249, D_814510313_D_814510313_D_532172400, D_814510313_D_814510313_D_754745617,
                    D_814510313_D_814510313_D_665036297, D_814510313_D_814510313_D_200837530, D_814510313_D_814510313_D_990319383, D_814510313_D_814510313_D_487917585,
                    D_814510313_D_814510313_D_603181162, D_814510313_D_814510313_D_482225200, D_814510313_D_814510313_D_764891959, D_814510313_D_814510313_D_139822395,
                    D_814510313_D_814510313_D_723614811, D_814510313_D_814510313_D_807835037, D_814510313_D_814510313_D_178420302)
momcnc_dx <- NULL
for (i in 1:23){
  dt <- as.data.frame(tab1(tmpM2[,i])$output.table)

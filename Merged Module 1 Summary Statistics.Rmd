...
This report analysis the responses of all Module 1 questions and visualizes the distributions of responses.
...
```{r, warning=FALSE, echo=FALSE, message=FALSE}
##Marital Status 
marital= data_tib_m1  %>%  mutate(status= case_when(D_783167257==288321056 ~ "Married", 
...
dt_marriage_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = c( "percentage"), decimals = 2) %>% 
...
dt_am_ind_ethn_summary %>%  gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dt_asian_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_black_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_hisp_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_mideast_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_hawi_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_white_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
data_tib_m1 %>%  select(D_555481393_D_979809707) %>% filter(!is.na(D_555481393_D_979809707)) %>% gt() %>% cols_label(D_555481393_D_979809707= md("**Response for 'Other' Sexual Orientation**"))
...
hiv_a_dg=boxp_funct(D_523188839_D_206625031,"HIV/AIDS Age at Diagnosis","Age") #unanswered
...
duct_a_dg=boxp_funct(D_219956652_D_206625031,"DCIS Age at Diagnosis","Age") #unanswered
...
tonsil_a_sg=boxp_funct(D_367884741_D_206625031,"Age of Tonisllectomy Surgery","Age") 
...
gall_a_sg=boxp_funct(D_178353079_D_206625031,"Age of Cholecystectomy Surgery","Age") 
...
apdx_a_sg=boxp_funct(D_550075233_D_206625031,"Age of Appendectomy Surgery","Age") 
apdx_y_sg=boxp_funct(D_550075233_D_261863326,"Year of Appendectomy Surgery","Year")
grid.arrange(apdx_a_sg, apdx_y_sg, nrow=2)


#	Liposuction
lipo_a_sg=boxp_funct(D_860920332_D_206625031,"Age of Liposuction Surgery","Age") 
...
bar_sg_a_sg=boxp_funct(D_986613440_D_206625031,"Age of Gastric Bypass Surgery","Age")
...
dt_breast_sg_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
# D_173240848_D_173240848_D_939782495, D_173240848_D_173240848_D_135725957,D_173240848_D_173240848_D_518416174,D_173240848_D_173240848_D_847945207,D_173240848_D_173240848_D_942970912,D_173240848_D_173240848_D_596122041,
#D_173240848_D_173240848_D_489400183,D_173240848_D_173240848_D_863246236,D_173240848_D_173240848_D_607793249,D_173240848_D_173240848_D_532172400,D_173240848_D_173240848_D_754745617,D_173240848_D_173240848_D_665036297,
#D_173240848_D_173240848_D_200837530,D_173240848_D_173240848_D_990319383, D_173240848_D_173240848_D_487917585,D_173240848_D_173240848_D_482225200,D_173240848_D_173240848_D_764891959,D_173240848_D_173240848_D_139822395,D_173240848_D_173240848_D_248374037,
#D_173240848_D_173240848_D_807835037,D_173240848_D_173240848_D_178420302,D_173240848_D_173240848_D_295976386)
...
dt_surgeryBrst <- surgeryBrst %>%  gt(rowname_col = "row_lab") %>%
  tab_header(title = md("BREASTSUR: Types of Breast Surgeries Had")) %>%
  cols_label(Frequency= md("**Number of Participants**"), Percentage=md("**Percentge of Participants**"),  Condition = md("**Answer**")) %>%
  # summary_rows(
  #   column = c(participants,percentage),
...
```{r, warning=FALSE, echo=FALSE, message=FALSE}
#cat("Breast Implants")
implant_a_sg=boxp_funct(D_477690298_D_623218391,"Age of Breats Implants Surgery","Age")
...
#cat("Mastopexy")
mastop_a_sg=boxp_funct(D_176453768_D_623218391,"Age of Mastopexy Surgery","Age")
...
boxp_funct(D_145786416_D_623218391,"Age of Breast Reconstruction Surgery","Age")
#recon_y_sg=boxp_funct(D_145786416_D_802622485,"Year of Breast Reconstruction Surgery","Year") unanswered
#grid.arrange(recon_a_sg, recon_y_sg, nrow=2)

#cat("Breast Reduction")
reduct_a_sg=boxp_funct(D_287605131_D_623218391,"Age of Breast Reduction Surgery","Age")
...
prtms_a_sg=boxp_funct(D_701157499_D_623218391,"Age of Partial Mastectomy Surgery","Age")
...
#cat("Mastectomy")
#mastec_a_sg=boxp_funct(D_428639167_D_623218391,"Age of Mastectomy Surgery","Age") #--none yet
boxp_funct(D_428639167_D_802622485,"Year of Mastectomy Surgery","Year") 
#grid.arrange(mastec_a_sg, mastec_y_sg, nrow=2)

#cat("Double Mastectomy")
dbmas_a_sg=boxp_funct(D_282355641_D_623218391,"Age of Double Mastectomy Surgery","Age")
...
#cat("Breast Abscess")
abscess_a_sg=boxp_funct(D_539301647_D_623218391,"Age of Breast Abscess Surgery","Age") 
...
lact_a_sg=boxp_funct(D_579225381_D_623218391,"Age of Removal of Lactiferous Surgery","Age")
...
othb_a_sg=boxp_funct(D_891214661_D_623218391,"Age of Other Breast Surgery","Age")
...
# simple_funct(D_808806810, "Weight Loss Between 18-25 Years Old Purposeful")
...
diff25 <- abs((data_tib_m1$D_912857732_D_121646540-data_tib_m1$D_912857732_D_821387277)/data_tib_m1$D_912857732_D_821387277)
diff35 <- abs((data_tib_m1$D_912857732_D_950080618-data_tib_m1$D_912857732_D_121646540)/data_tib_m1$D_912857732_D_121646540)
diff45 <- abs((data_tib_m1$D_912857732_D_407167089-data_tib_m1$D_912857732_D_950080618)/data_tib_m1$D_912857732_D_950080618)
diff55 <- abs((data_tib_m1$D_912857732_D_503154158-data_tib_m1$D_912857732_D_407167089)/data_tib_m1$D_912857732_D_407167089)
...
dt_dad_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_dad_dthage_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#testicular
boxp_funct(D_359291056_D_206625031,"Father's Age at Testicular Cancer Diagnosis","Age")
# boxp_funct(D_359291056_D_261863326,"Father's Year of Testicular Cancer Diagnosis","Year") 
#grid.arrange(test_a_ddg, test_y_ddg, nrow=2)
 
#thyroid
boxp_funct(D_968841976_D_206625031,"Father's Age at Thyriod Cancer Diagnosis","Age")
# boxp_funct(D_968841976_D_261863326,"Father's Year of Thyriod Cancer Diagnosis","Year") 
...
sib_logic_funct(D_807431780_2_2, 2, "MULT2_2: Sibling 2 a Twin or Multiple")
sib_logic_funct(D_807431780_3_3, 3, "MULT2_3: Sibling 3 a Twin or Multiple")
sib_logic_funct(D_807431780_4_4, 4, "MULT2_4: Sibling 4 a Twin or Multiple")
sib_logic_funct(D_807431780_5_5, 5, "MULT2_5: Sibling 5 a Twin or Multiple")
sib_logic_funct(D_807431780_6_6, 6, "MULT2_6: Sibling 6 a Twin or Multiple")
sib_logic_funct(D_807431780_7_7, 7, "MULT2_7: Sibling 7 a Twin or Multiple")
sib_logic_funct(D_807431780_8_8, 8, "MULT2_8: Sibling 8 a Twin or Multiple")
...
# boxp_funct(D_384881609_1_1_D_206625031_1_1,"Age Sibling 1 Anal Cancer Diagnosed", "Age")
# boxp_funct(D_384881609_1_1_D_261863326_1_1,"Year Sibling 1 Anal Cancer Diagnosed", "Year")
# boxp_funct(D_483975329_1_1_D_206625031_1_1,"Age Sibling 1 Bladder Cancer Diagnosed", "Age")
# boxp_funct(D_483975329_1_1_D_261863326_1_1,"Year Sibling 1 Bladder Cancer Diagnosed", "Year")
sib1_c1=boxp_funct(D_570279754_1_1_D_206625031_1_1,"Age Sibling 1 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_1_1_D_261863326_1_1,"Year Sibling 1 Brain Cancer Diagnosed", "Year")
sib1_c2=boxp_funct(D_907590067_1_1_D_206625031_1_1,"Age Sibling 1 Breast Cancer Diagnosed", "Age")
#boxp_funct(D_907590067_1_1_D_261863326_1_1,"Year Sibling 1 Breast Cancer Diagnosed", "Year")
sib1_c3=boxp_funct(D_860112841_1_1_D_206625031_1_1,"Age Sibling 1 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_1_1_D_261863326_1_1,"Year Sibling 1 Cervical Cancer Diagnosed", "Year")
sib1_c4=boxp_funct(D_158354252_1_1_D_206625031_1_1,"Age Sibling 1 Colon Cancer Diagnosed", "Age")
sib1_c5=boxp_funct(D_158354252_1_1_D_261863326_1_1,"Year Sibling 1 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_1_1_D_206625031_1_1,"Age Sibling 1 Esophageal Cancer Diagnosed", "Age") #missing
#boxp_funct(D_654594205_1_1_D_261863326_1_1,"Year Sibling 1 Esophageal Cancer Diagnosed", "Year") #missing
#boxp_funct(D_550722030_1_1_D_206625031_1_1,"Age Sibling 1 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_1_1_D_261863326_1_1,"Year Sibling 1 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_1_1_D_206625031_1_1,"Age Sibling 1 Kidney Cancer Diagnosed", "Age") #missing
#boxp_funct(D_142912472_1_1_D_261863326_1_1,"Year Sibling 1 Kidney Cancer Diagnosed", "Year") 
#boxp_funct(D_158409298_1_1_D_206625031_1_1,"Age Sibling 1 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_1_1_D_261863326_1_1,"Year Sibling 1 Leukemia Cancer Diagnosed", "Year")
sib1_c6=boxp_funct(D_529744595_1_1_D_206625031_1_1,"Age Sibling 1 Liver Cancer Diagnosed", "Age") 
#boxp_funct(D_529744595_1_1_D_261863326_1_1,"Year Sibling 1 Liver Cancer Diagnosed", "Year") 
sib1_c7=boxp_funct(D_315987564_1_1_D_206625031_1_1,"Age Sibling 1 Lung Cancer Diagnosed", "Age") 
#boxp_funct(D_315987564_1_1_D_261863326_1_1,"Year Sibling 1 Lung Cancer Diagnosed", "Year") 
sib1_c8=boxp_funct(D_852278004_1_1_D_206625031_1_1,"Age Sibling 1 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
#sib1_c1=boxp_funct(D_852278004_1_1_D_261863326_1_1,"Year Sibling 1 Non-Hodgkins Lymphoma Cancer Diagnosed", "Year")
sib1_c9=boxp_funct(D_391972881_1_1_D_206625031_1_1,"Age Sibling 1 Lymphoma Cancer Diagnosed", "Age") 
sib1_c10=boxp_funct(D_259089008_1_1_D_206625031_1_1,"Age Sibling 1 Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_259089008_1_1_D_261863326_1_1,"Year Sibling 1 Melanoma Cancer Diagnosed", "Year")
sib1_c11=boxp_funct(D_209771602_1_1_D_206625031_1_1,"Age Sibling 1 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_1_1_D_261863326_1_1,"Year Sibling 1 Non-Melanoma Cancer Diagnosed", "Year")
sib1_c12=boxp_funct(D_682651189_1_1_D_206625031_1_1,"Age Sibling 1 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_1_1_D_261863326_1_1,"Year Sibling 1 Ovarian Cancer Diagnosed", "Year") 
sib1_c13=boxp_funct(D_750994269_1_1_D_206625031_1_1,"Age Sibling 1 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_1_1_D_261863326_1_1,"Year Sibling 1 Pancreatic Cancer Diagnosed", "Year") 
sib1_c14=boxp_funct(D_700889863_1_1_D_206625031_1_1,"Age Sibling 1 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_1_1_D_261863326_1_1,"Year Sibling 1 Prostate Cancer Diagnosed", "Year")
sib1_c15=boxp_funct(D_990114799_1_1_D_206625031_1_1,"Age Sibling 1 Stomach Cancer Diagnosed", "Age")
sib1_c16=boxp_funct(D_990114799_1_1_D_261863326_1_1,"Year Sibling 1 Stomach Cancer Diagnosed", "Year")
#boxp_funct(D_195363361_1_1_D_206625031_1_1,"Age Sibling 1 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_1_1_D_261863326_1_1,"Year Sibling 1 Testicular Cancer Diagnosed", "Year")
#boxp_funct(D_216840563_1_1_D_206625031_1_1,"Age Sibling 1 Thyroid Cancer Diagnosed", "Age")
sib1_c17=boxp_funct(D_216840563_1_1_D_261863326_1_1,"Year Sibling 1 Thyroid Cancer Diagnosed", "Year")
sib1_c18=boxp_funct(D_514034680_1_1_D_206625031_1_1,"Age Sibling 1 Uterine Cancer Diagnosed", "Age") 
#boxp_funct(D_514034680_1_1_D_261863326_1_1,"Year Sibling 1 Uterine Cancer Diagnosed", "Year") 
sib1_c19=boxp_funct(D_247160067_1_1_D_206625031_1_1,"Age Sibling 1 Other Cancer Diagnosed", "Age")
sib1_c20=boxp_funct(D_247160067_1_1_D_261863326_1_1,"Year Sibling 1 Other Cancer Diagnosed", "Year")
sib1_c21=boxp_funct(D_312545873_1_1_D_206625031_1_1,"Age Sibling 1 Unknown Cancer Diagnosed", "Age")
#boxp_funct(D_312545873_1_1_D_261863326_1_1,"Year Sibling 1 Unknown Cancer Diagnosed", "Year")
grid.arrange(sib1_c1, sib1_c2, nrow=2)
grid.arrange(sib1_c3, sib1_c4, nrow=2)
grid.arrange(sib1_c5, sib1_c6, nrow=2)
grid.arrange(sib1_c7, sib1_c8, nrow=2)
grid.arrange(sib1_c9, sib1_c10, nrow=2)
grid.arrange(sib1_c11, sib1_c12, nrow=2)
grid.arrange(sib1_c13, sib1_c14, nrow=2)
grid.arrange(sib1_c15, sib1_c16, nrow=2)
grid.arrange(sib1_c17, sib1_c18, nrow=2)
grid.arrange(sib1_c18, sib1_c20, sib1_c21, nrow=3)


#boxp_funct(D_384881609_2_2_D_206625031_2_2,"Age Sibling 2 Anal Cancer Diagnosed", "Age")
#boxp_funct(D_384881609_2_2_D_261863326_2_2,"Year Sibling 2 Anal Cancer Diagnosed", "Year")
#boxp_funct(D_483975329_2_2_D_206625031_2_2,"Age Sibling 2 Bladder Cancer Diagnosed", "Age")
#boxp_funct(D_483975329_2_2_D_261863326_2_2,"Year Sibling 2 Bladder Cancer Diagnosed", "Year")
#boxp_funct(D_570279754_2_2_D_206625031_2_2,"Age Sibling 2 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_2_2_D_261863326_2_2,"Year Sibling 2 Brain Cancer Diagnosed", "Year")
sib2_c1=boxp_funct(D_907590067_2_2_D_206625031_2_2,"Age Sibling 2 Breast Cancer Diagnosed", "Age")
#boxp_funct(D_907590067_2_2_D_261863326_2_2,"Year Sibling 2 Breast Cancer Diagnosed", "Year")
#boxp_funct(D_860112841_2_2_D_206625031_2_2,"Age Sibling 2 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_2_2_D_261863326_2_2,"Year Sibling 2 Cervical Cancer Diagnosed", "Year")
sib2_c2=boxp_funct(D_158354252_2_2_D_206625031_2_2,"Age Sibling 2 Colon Cancer Diagnosed", "Age")
#boxp_funct(D_158354252_2_2_D_261863326_2_2,"Year Sibling 2 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_2_2_D_206625031_2_2,"Age Sibling 2 Esophageal Cancer Diagnosed", "Age") 
#boxp_funct(D_654594205_2_2_D_261863326_2_2,"Year Sibling 2 Esophageal Cancer Diagnosed", "Year") 
#boxp_funct(D_550722030_2_2_D_206625031_2_2,"Age Sibling 2 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_2_2_D_261863326_2_2,"Year Sibling 2 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_2_2_D_206625031_2_2,"Age Sibling 2 Kidney Cancer Diagnosed", "Age") 
sib2_c3=boxp_funct(D_142912472_2_2_D_261863326_2_2,"Year Sibling 2 Kidney Cancer Diagnosed", "Year") 
sib2_c4=boxp_funct(D_158409298_2_2_D_206625031_2_2,"Age Sibling 2 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_2_2_D_261863326_2_2,"Year Sibling 2 Leukemia Cancer Diagnosed", "Year")
#boxp_funct(D_529744595_2_2_D_206625031_2_2,"Age Sibling 2 Liver Cancer Diagnosed", "Age") 
sib2_c5=boxp_funct(D_529744595_2_2_D_261863326_2_2,"Year Sibling 2 Liver Cancer Diagnosed", "Year") 
sib2_c6=boxp_funct(D_315987564_2_2_D_206625031_2_2,"Age Sibling 2 Lung Cancer Diagnosed", "Age") 
sib2_c7=boxp_funct(D_315987564_2_2_D_261863326_2_2,"Year Sibling 2 Lung Cancer Diagnosed", "Year") 
sib2_c8=boxp_funct(D_852278004_2_2_D_206625031_2_2,"Age Sibling 2 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
#boxp_funct(D_852278004_2_2_D_261863326_2_2,"Year Sibling 2 Non-Hodgkins Lymphoma Cancer Diagnosed", "Year")
#boxp_funct(D_391972881_2_2_D_206625031_2_2,"Age Sibling 2 Lymphoma Cancer Diagnosed", "Age") 
sib2_c9=boxp_funct(D_259089008_2_2_D_206625031_2_2,"Age Sibling 2 Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_259089008_2_2_D_261863326_2_2,"Year Sibling 2 Melanoma Cancer Diagnosed", "Year")
sib2_c10=boxp_funct(D_209771602_2_2_D_206625031_2_2,"Age Sibling 2 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_2_2_D_261863326_2_2,"Year Sibling 2 Non-Melanoma Cancer Diagnosed", "Year")
sib2_c11=boxp_funct(D_682651189_2_2_D_206625031_2_2,"Age Sibling 2 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_2_2_D_261863326_2_2,"Year Sibling 2 Ovarian Cancer Diagnosed", "Year") 
#boxp_funct(D_750994269_2_2_D_206625031_2_2,"Age Sibling 2 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_2_2_D_261863326_2_2,"Year Sibling 2 Pancreatic Cancer Diagnosed", "Year") 
sib2_c12=boxp_funct(D_700889863_2_2_D_206625031_2_2,"Age Sibling 2 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_2_2_D_261863326_2_2,"Year Sibling 2 Prostate Cancer Diagnosed", "Year")
#boxp_funct(D_990114799_2_2_D_206625031_2_2,"Age Sibling 2 Stomach Cancer Diagnosed", "Age")
#boxp_funct(D_990114799_2_2_D_261863326_2_2,"Year Sibling 2 Stomach Cancer Diagnosed", "Year")
sib2_c13=boxp_funct(D_195363361_2_2_D_206625031_2_2,"Age Sibling 2 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_2_2_D_261863326_2_2,"Year Sibling 2 Testicular Cancer Diagnosed", "Year")
sib2_c14=boxp_funct(D_216840563_2_2_D_206625031_2_2,"Age Sibling 2 Thyroid Cancer Diagnosed", "Age")
sib2_c15=boxp_funct(D_216840563_2_2_D_261863326_2_2,"Year Sibling 2 Thyroid Cancer Diagnosed", "Year")
#boxp_funct(D_514034680_2_2_D_206625031_2_2,"Age Sibling 2 Uterine Cancer Diagnosed", "Age") 
#boxp_funct(D_514034680_2_2_D_261863326_2_2,"Year Sibling 2 Uterine Cancer Diagnosed", "Year") 
sib2_c16=boxp_funct(D_247160067_2_2_D_206625031_2_2,"Age Sibling 2 Other Cancer Diagnosed", "Age")
#boxp_funct(D_247160067_2_2_D_261863326_2_2,"Year Sibling 2 Other Cancer Diagnosed", "Year")
#boxp_funct(D_312545873_2_2_D_206625031_2_2,"Age Sibling 2 Unknown Cancer Diagnosed", "Age")
#boxp_funct(D_312545873_2_2_D_261863326_2_2,"Year Sibling 2 Unknown Cancer Diagnosed", "Year")
grid.arrange(sib2_c1, sib2_c2, nrow=2)
grid.arrange(sib2_c3, sib2_c4, nrow=2)
grid.arrange(sib2_c5, sib2_c6, nrow=2)
grid.arrange(sib2_c7, sib2_c8, nrow=2)
grid.arrange(sib2_c9, sib2_c10, nrow=2)
grid.arrange(sib2_c11, sib2_c12, nrow=2)
grid.arrange(sib2_c13, sib2_c14, nrow=2)
grid.arrange(sib2_c15, sib2_c16, nrow=2)
...
#boxp_funct(D_483975329_3_3_D_206625031_3_3,"Age Sibling 3 Bladder Cancer Diagnosed", "Age")
#boxp_funct(D_483975329_3_3_D_261863326_3_3,"Year Sibling 3 Bladder Cancer Diagnosed", "Year")
sib3_c1=boxp_funct(D_570279754_3_3_D_206625031_3_3,"Age Sibling 3 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_3_3_D_261863326_3_3,"Year Sibling 3 Brain Cancer Diagnosed", "Year")
sib3_c2=boxp_funct(D_907590067_3_3_D_206625031_3_3,"Age Sibling 3 Breast Cancer Diagnosed", "Age")
sib3_c3=boxp_funct(D_907590067_3_3_D_261863326_3_3,"Year Sibling 3 Breast Cancer Diagnosed", "Year")
#boxp_funct(D_860112841_3_3_D_206625031_3_3,"Age Sibling 3 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_3_3_D_261863326_3_3,"Year Sibling 3 Cervical Cancer Diagnosed", "Year")
sib3_c4=boxp_funct(D_158354252_3_3_D_206625031_3_3,"Age Sibling 3 Colon Cancer Diagnosed", "Age")
#boxp_funct(D_158354252_3_3_D_261863326_3_3,"Year Sibling 3 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_3_3_D_206625031_3_3,"Age Sibling 3 Esophageal Cancer Diagnosed", "Age") 
#boxp_funct(D_654594205_3_3_D_261863326_3_3,"Year Sibling 3 Esophageal Cancer Diagnosed", "Year") 
#boxp_funct(D_550722030_3_3_D_206625031_3_3,"Age Sibling 3 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_3_3_D_261863326_3_3,"Year Sibling 3 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_3_3_D_206625031_3_3,"Age Sibling 3 Kidney Cancer Diagnosed", "Age") 
#boxp_funct(D_142912472_3_3_D_261863326_3_3,"Year Sibling 3 Kidney Cancer Diagnosed", "Year") 
#boxp_funct(D_158409298_3_3_D_206625031_3_3,"Age Sibling 3 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_3_3_D_261863326_3_3,"Year Sibling 3 Leukemia Cancer Diagnosed", "Year")
#boxp_funct(D_529744595_3_3_D_206625031_3_3,"Age Sibling 3 Liver Cancer Diagnosed", "Age") 
#boxp_funct(D_529744595_3_3_D_261863326_3_3,"Year Sibling 3 Liver Cancer Diagnosed", "Year") 
sib3_c5=boxp_funct(D_315987564_3_3_D_206625031_3_3,"Age Sibling 3 Lung Cancer Diagnosed", "Age") 
#boxp_funct(D_315987564_3_3_D_261863326_3_3,"Year Sibling 3 Lung Cancer Diagnosed", "Year") 
#boxp_funct(D_852278004_3_3_D_206625031_3_3,"Age Sibling 3 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
#boxp_funct(D_852278004_3_3_D_261863326_3_3,"Year Sibling 3 Non-Hodgkins Lymphoma Cancer Diagnosed", "Year")
#boxp_funct(D_391972881_3_3_D_206625031_3_3,"Age Sibling 3 Lymphoma Cancer Diagnosed", "Age") 
sib3_c6=boxp_funct(D_259089008_3_3_D_206625031_3_3,"Age Sibling 3 Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_259089008_3_3_D_261863326_3_3,"Year Sibling 3 Melanoma Cancer Diagnosed", "Year")
sib3_c7=boxp_funct(D_209771602_3_3_D_206625031_3_3,"Age Sibling 3 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_3_3_D_261863326_3_3,"Year Sibling 3 Non-Melanoma Cancer Diagnosed", "Year")
#boxp_funct(D_682651189_3_3_D_206625031_3_3,"Age Sibling 3 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_3_3_D_261863326_3_3,"Year Sibling 3 Ovarian Cancer Diagnosed", "Year") 
#boxp_funct(D_750994269_3_3_D_206625031_3_3,"Age Sibling 3 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_3_3_D_261863326_3_3,"Year Sibling 3 Pancreatic Cancer Diagnosed", "Year") 
#boxp_funct(D_700889863_3_3_D_206625031_3_3,"Age Sibling 3 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_3_3_D_261863326_3_3,"Year Sibling 3 Prostate Cancer Diagnosed", "Year")
#boxp_funct(D_990114799_3_3_D_206625031_3_3,"Age Sibling 3 Stomach Cancer Diagnosed", "Age")
#boxp_funct(D_990114799_3_3_D_261863326_3_3,"Year Sibling 3 Stomach Cancer Diagnosed", "Year")
#boxp_funct(D_195363361_3_3_D_206625031_3_3,"Age Sibling 3 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_3_3_D_261863326_3_3,"Year Sibling 3 Testicular Cancer Diagnosed", "Year")
sib3_c8=boxp_funct(D_216840563_3_3_D_206625031_3_3,"Age Sibling 3 Thyroid Cancer Diagnosed", "Age")
#boxp_funct(D_216840563_3_3_D_261863326_3_3,"Year Sibling 3 Thyroid Cancer Diagnosed", "Year")
#boxp_funct(D_514034680_3_3_D_206625031_3_3,"Age Sibling 3 Uterine Cancer Diagnosed", "Age") 
#boxp_funct(D_514034680_3_3_D_261863326_3_3,"Year Sibling 3 Uterine Cancer Diagnosed", "Year") 
#boxp_funct(D_247160067_3_3_D_206625031_3_3,"Age Sibling 3 Other Cancer Diagnosed", "Age")
#boxp_funct(D_247160067_3_3_D_261863326_3_3,"Year Sibling 3 Other Cancer Diagnosed", "Year")
sib3_c9=boxp_funct(D_312545873_3_3_D_206625031_3_3,"Age Sibling 3 Unknown Cancer Diagnosed", "Age")
sib3_c10=boxp_funct(D_312545873_3_3_D_261863326_3_3,"Year Sibling 3 Unknown Cancer Diagnosed", "Year")
grid.arrange(sib3_c1, sib3_c2, nrow=2)
grid.arrange(sib3_c3, sib3_c4, nrow=2)
grid.arrange(sib3_c5, sib3_c6, nrow=2)
grid.arrange(sib3_c7, sib3_c8, nrow=2)
grid.arrange(sib3_c9, sib3_c10, nrow=2)


#boxp_funct(D_384881609_4_4_D_206625031_4_4,"Age Sibling 4 Anal Cancer Diagnosed", "Age")
#boxp_funct(D_384881609_4_4_D_261863326_4_4,"Year Sibling 4 Anal Cancer Diagnosed", "Year")
#boxp_funct(D_483975329_4_4_D_206625031_4_4,"Age Sibling 4 Bladder Cancer Diagnosed", "Age")
#boxp_funct(D_483975329_4_4_D_261863326_4_4,"Year Sibling 4 Bladder Cancer Diagnosed", "Year")
#boxp_funct(D_570279754_4_4_D_206625031_4_4,"Age Sibling 4 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_4_4_D_261863326_4_4,"Year Sibling 4 Brain Cancer Diagnosed", "Year")
sib4_c1=boxp_funct(D_907590067_4_4_D_206625031_4_4,"Age Sibling 4 Breast Cancer Diagnosed", "Age")
sib4_c2=boxp_funct(D_907590067_4_4_D_261863326_4_4,"Year Sibling 4 Breast Cancer Diagnosed", "Year")
#boxp_funct(D_860112841_4_4_D_206625031_4_4,"Age Sibling 4 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_4_4_D_261863326_4_4,"Year Sibling 4 Cervical Cancer Diagnosed", "Year")
#boxp_funct(D_158354252_4_4_D_206625031_4_4,"Age Sibling 4 Colon Cancer Diagnosed", "Age")
#boxp_funct(D_158354252_4_4_D_261863326_4_4,"Year Sibling 4 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_4_4_D_206625031_4_4,"Age Sibling 4 Esophageal Cancer Diagnosed", "Age") 
#boxp_funct(D_654594205_4_4_D_261863326_4_4,"Year Sibling 4 Esophageal Cancer Diagnosed", "Year") 
#boxp_funct(D_550722030_4_4_D_206625031_4_4,"Age Sibling 4 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_4_4_D_261863326_4_4,"Year Sibling 4 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_4_4_D_206625031_4_4,"Age Sibling 4 Kidney Cancer Diagnosed", "Age") 
#boxp_funct(D_142912472_4_4_D_261863326_4_4,"Year Sibling 4 Kidney Cancer Diagnosed", "Year") 
#boxp_funct(D_158409298_4_4_D_206625031_4_4,"Age Sibling 4 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_4_4_D_261863326_4_4,"Year Sibling 4 Leukemia Cancer Diagnosed", "Year")
#boxp_funct(D_529744595_4_4_D_206625031_4_4,"Age Sibling 4 Liver Cancer Diagnosed", "Age") 
#boxp_funct(D_529744595_4_4_D_261863326_4_4,"Year Sibling 4 Liver Cancer Diagnosed", "Year") 
sib4_c3=boxp_funct(D_315987564_4_4_D_206625031_4_4,"Age Sibling 4 Lung Cancer Diagnosed", "Age") 
#boxp_funct(D_315987564_4_4_D_261863326_4_4,"Year Sibling 4 Lung Cancer Diagnosed", "Year") 
#boxp_funct(D_852278004_4_4_D_206625031_4_4,"Age Sibling 4 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
#boxp_funct(D_852278004_4_4_D_261863326_4_4,"Year Sibling 4 Non-Hodgkins Lymphoma Cancer Diagnosed", "Year")
#boxp_funct(D_391972881_4_4_D_206625031_4_4,"Age Sibling 4 Lymphoma Cancer Diagnosed", "Age") 
#boxp_funct(D_259089008_4_4_D_206625031_4_4,"Age Sibling 4 Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_259089008_4_4_D_261863326_4_4,"Year Sibling 4 Melanoma Cancer Diagnosed", "Year")
#boxp_funct(D_209771602_4_4_D_206625031_4_4,"Age Sibling 4 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_4_4_D_261863326_4_4,"Year Sibling 4 Non-Melanoma Cancer Diagnosed", "Year")
sib4_c4=boxp_funct(D_682651189_4_4_D_206625031_4_4,"Age Sibling 4 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_4_4_D_261863326_4_4,"Year Sibling 4 Ovarian Cancer Diagnosed", "Year") 
#boxp_funct(D_750994269_4_4_D_206625031_4_4,"Age Sibling 4 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_4_4_D_261863326_4_4,"Year Sibling 4 Pancreatic Cancer Diagnosed", "Year") 
sib4_c5=boxp_funct(D_700889863_4_4_D_206625031_4_4,"Age Sibling 4 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_4_4_D_261863326_4_4,"Year Sibling 4 Prostate Cancer Diagnosed", "Year")
#boxp_funct(D_990114799_4_4_D_206625031_4_4,"Age Sibling 4 Stomach Cancer Diagnosed", "Age")
#boxp_funct(D_990114799_4_4_D_261863326_4_4,"Year Sibling 4 Stomach Cancer Diagnosed", "Year")
#boxp_funct(D_195363361_4_4_D_206625031_4_4,"Age Sibling 4 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_4_4_D_261863326_4_4,"Year Sibling 4 Testicular Cancer Diagnosed", "Year")
sib4_c6=boxp_funct(D_216840563_4_4_D_206625031_4_4,"Age Sibling 4 Thyroid Cancer Diagnosed", "Age")
#boxp_funct(D_216840563_4_4_D_261863326_4_4,"Year Sibling 4 Thyroid Cancer Diagnosed", "Year")
#boxp_funct(D_514034680_4_4_D_206625031_4_4,"Age Sibling 4 Uterine Cancer Diagnosed", "Age") 
#boxp_funct(D_514034680_4_4_D_261863326_4_4,"Year Sibling 4 Uterine Cancer Diagnosed", "Year") 
#boxp_funct(D_247160067_4_4_D_206625031_4_4,"Age Sibling 4 Other Cancer Diagnosed", "Age")
#boxp_funct(D_247160067_4_4_D_261863326_4_4,"Year Sibling 4 Other Cancer Diagnosed", "Year")
#boxp_funct(D_312545873_4_4_D_206625031_4_4,"Age Sibling 4 Unknown Cancer Diagnosed", "Age")
#boxp_funct(D_312545873_4_4_D_261863326_4_4,"Year Sibling 4 Unknown Cancer Diagnosed", "Year")
grid.arrange(sib4_c1, sib4_c2, nrow=2)
grid.arrange(sib4_c3, sib4_c4, nrow=2)
grid.arrange(sib4_c5, sib4_c6, nrow=2)
...
#boxp_funct(D_483975329_5_5_D_206625031_5_5,"Age Sibling 5 Bladder Cancer Diagnosed", "Age")
#boxp_funct(D_483975329_5_5_D_261863326_5_5,"Year Sibling 5 Bladder Cancer Diagnosed", "Year")
#boxp_funct(D_570279754_5_5_D_206625031_5_5,"Age Sibling 5 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_5_5_D_261863326_5_5,"Year Sibling 5 Brain Cancer Diagnosed", "Year")
sib5_c1=boxp_funct(D_907590067_5_5_D_206625031_5_5,"Age Sibling 5 Breast Cancer Diagnosed", "Age")
#boxp_funct(D_907590067_5_5_D_261863326_5_5,"Year Sibling 5 Breast Cancer Diagnosed", "Year")
#boxp_funct(D_860112841_5_5_D_206625031_5_5,"Age Sibling 5 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_5_5_D_261863326_5_5,"Year Sibling 5 Cervical Cancer Diagnosed", "Year")
#boxp_funct(D_158354252_5_5_D_206625031_5_5,"Age Sibling 5 Colon Cancer Diagnosed", "Age")
#boxp_funct(D_158354252_5_5_D_261863326_5_5,"Year Sibling 5 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_5_5_D_206625031_5_5,"Age Sibling 5 Esophageal Cancer Diagnosed", "Age") 
#boxp_funct(D_654594205_5_5_D_261863326_5_5,"Year Sibling 5 Esophageal Cancer Diagnosed", "Year") 
#boxp_funct(D_550722030_5_5_D_206625031_5_5,"Age Sibling 5 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_5_5_D_261863326_5_5,"Year Sibling 5 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_5_5_D_206625031_5_5,"Age Sibling 5 Kidney Cancer Diagnosed", "Age") 
#boxp_funct(D_142912472_5_5_D_261863326_5_5,"Year Sibling 5 Kidney Cancer Diagnosed", "Year") 
#boxp_funct(D_158409298_5_5_D_206625031_5_5,"Age Sibling 5 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_5_5_D_261863326_5_5,"Year Sibling 5 Leukemia Cancer Diagnosed", "Year")
#boxp_funct(D_529744595_5_5_D_206625031_5_5,"Age Sibling 5 Liver Cancer Diagnosed", "Age") 
#boxp_funct(D_529744595_5_5_D_261863326_5_5,"Year Sibling 5 Liver Cancer Diagnosed", "Year") 
#boxp_funct(D_315987564_5_5_D_206625031_5_5,"Age Sibling 5 Lung Cancer Diagnosed", "Age") 
#boxp_funct(D_315987564_5_5_D_261863326_5_5,"Year Sibling 5 Lung Cancer Diagnosed", "Year") 
#boxp_funct(D_852278004_5_5_D_206625031_5_5,"Age Sibling 5 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
...
sib5_c2=boxp_funct(D_259089008_5_5_D_206625031_5_5,"Age Sibling 5 Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_259089008_5_5_D_261863326_5_5,"Year Sibling 5 Melanoma Cancer Diagnosed", "Year")
#boxp_funct(D_209771602_5_5_D_206625031_5_5,"Age Sibling 5 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_5_5_D_261863326_5_5,"Year Sibling 5 Non-Melanoma Cancer Diagnosed", "Year")
#boxp_funct(D_682651189_5_5_D_206625031_5_5,"Age Sibling 5 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_5_5_D_261863326_5_5,"Year Sibling 5 Ovarian Cancer Diagnosed", "Year") 
#boxp_funct(D_750994269_5_5_D_206625031_5_5,"Age Sibling 5 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_5_5_D_261863326_5_5,"Year Sibling 5 Pancreatic Cancer Diagnosed", "Year") 
#boxp_funct(D_700889863_5_5_D_206625031_5_5,"Age Sibling 5 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_5_5_D_261863326_5_5,"Year Sibling 5 Prostate Cancer Diagnosed", "Year")
#boxp_funct(D_990114799_5_5_D_206625031_5_5,"Age Sibling 5 Stomach Cancer Diagnosed", "Age")
#boxp_funct(D_990114799_5_5_D_261863326_5_5,"Year Sibling 5 Stomach Cancer Diagnosed", "Year")
#boxp_funct(D_195363361_5_5_D_206625031_5_5,"Age Sibling 5 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_5_5_D_261863326_5_5,"Year Sibling 5 Testicular Cancer Diagnosed", "Year")
sib5_c3=boxp_funct(D_216840563_5_5_D_206625031_5_5,"Age Sibling 5 Thyroid Cancer Diagnosed", "Age")
#boxp_funct(D_216840563_5_5_D_261863326_5_5,"Year Sibling 5 Thyroid Cancer Diagnosed", "Year")
#boxp_funct(D_514034680_5_5_D_206625031_5_5,"Age Sibling 5 Uterine Cancer Diagnosed", "Age") 
#boxp_funct(D_514034680_5_5_D_261863326_5_5,"Year Sibling 5 Uterine Cancer Diagnosed", "Year") 
...
#boxp_funct(D_312545873_5_5_D_206625031_5_5,"Age Sibling 5 Unknown Cancer Diagnosed", "Age")
#boxp_funct(D_312545873_5_5_D_261863326_5_5,"Year Sibling 5 Unknown Cancer Diagnosed", "Year")
grid.arrange(sib5_c1, sib5_c2, sib5_c3, nrow=3)
...
#boxp_funct(D_483975329_6_6_D_261863326_6_6,"Year Sibling 6 Bladder Cancer Diagnosed", "Year")
#boxp_funct(D_570279754_6_6_D_206625031_6_6,"Age Sibling 6 Brain Cancer Diagnosed", "Age")
#boxp_funct(D_570279754_6_6_D_261863326_6_6,"Year Sibling 6 Brain Cancer Diagnosed", "Year")
#boxp_funct(D_907590067_6_6_D_206625031_6_6,"Age Sibling 6 Breast Cancer Diagnosed", "Age")
#boxp_funct(D_907590067_6_6_D_261863326_6_6,"Year Sibling 6 Breast Cancer Diagnosed", "Year")
#boxp_funct(D_860112841_6_6_D_206625031_6_6,"Age Sibling 6 Cervical Cancer Diagnosed", "Age")
#boxp_funct(D_860112841_6_6_D_261863326_6_6,"Year Sibling 6 Cervical Cancer Diagnosed", "Year")
#boxp_funct(D_158354252_6_6_D_206625031_6_6,"Age Sibling 6 Colon Cancer Diagnosed", "Age")
#boxp_funct(D_158354252_6_6_D_261863326_6_6,"Year Sibling 6 Colon Cancer Diagnosed", "Year")
#boxp_funct(D_654594205_6_6_D_206625031_6_6,"Age Sibling 6 Esophageal Cancer Diagnosed", "Age") 
#boxp_funct(D_654594205_6_6_D_261863326_6_6,"Year Sibling 6 Esophageal Cancer Diagnosed", "Year") 
#boxp_funct(D_550722030_6_6_D_206625031_6_6,"Age Sibling 6 Heck Neck and Shoulders Cancer Diagnosed", "Age") 
#boxp_funct(D_550722030_6_6_D_261863326_6_6,"Year Sibling 6 Heck Neck and Shoulders Cancer Diagnosed", "Year")
#boxp_funct(D_142912472_6_6_D_206625031_6_6,"Age Sibling 6 Kidney Cancer Diagnosed", "Age") 
#boxp_funct(D_142912472_6_6_D_261863326_6_6,"Year Sibling 6 Kidney Cancer Diagnosed", "Year") 
#boxp_funct(D_158409298_6_6_D_206625031_6_6,"Age Sibling 6 Leukemia Cancer Diagnosed", "Age")
#boxp_funct(D_158409298_6_6_D_261863326_6_6,"Year Sibling 6 Leukemia Cancer Diagnosed", "Year")
#boxp_funct(D_529744595_6_6_D_206625031_6_6,"Age Sibling 6 Liver Cancer Diagnosed", "Age") 
#boxp_funct(D_529744595_6_6_D_261863326_6_6,"Year Sibling 6 Liver Cancer Diagnosed", "Year") 
#boxp_funct(D_315987564_6_6_D_206625031_6_6,"Age Sibling 6 Lung Cancer Diagnosed", "Age") 
#boxp_funct(D_315987564_6_6_D_261863326_6_6,"Year Sibling 6 Lung Cancer Diagnosed", "Year") 
#boxp_funct(D_852278004_6_6_D_206625031_6_6,"Age Sibling 6 Non-Hodgkins Lymphoma Cancer Diagnosed", "Age")
#boxp_funct(D_852278004_6_6_D_261863326_6_6,"Year Sibling 6 Non-Hodgkins Lymphoma Cancer Diagnosed", "Year")
#boxp_funct(D_391972881_6_6_D_206625031_6_6,"Age Sibling 6 Lymphoma Cancer Diagnosed", "Age") 
...
#boxp_funct(D_209771602_6_6_D_206625031_6_6,"Age Sibling 6 Non-Melanoma Cancer Diagnosed", "Age")
#boxp_funct(D_209771602_6_6_D_261863326_6_6,"Year Sibling 6 Non-Melanoma Cancer Diagnosed", "Year")
#boxp_funct(D_682651189_6_6_D_206625031_6_6,"Age Sibling 6 Ovarian Cancer Diagnosed", "Age") 
#boxp_funct(D_682651189_6_6_D_261863326_6_6,"Year Sibling 6 Ovarian Cancer Diagnosed", "Year") 
#boxp_funct(D_750994269_6_6_D_206625031_6_6,"Age Sibling 6 Pancreatic Cancer Diagnosed", "Age") 
#boxp_funct(D_750994269_6_6_D_261863326_6_6,"Year Sibling 6 Pancreatic Cancer Diagnosed", "Year") 
#boxp_funct(D_700889863_6_6_D_206625031_6_6,"Age Sibling 6 Prostate Cancer Diagnosed", "Age")
#boxp_funct(D_700889863_6_6_D_261863326_6_6,"Year Sibling 6 Prostate Cancer Diagnosed", "Year")
#boxp_funct(D_990114799_6_6_D_206625031_6_6,"Age Sibling 6 Stomach Cancer Diagnosed", "Age")
#boxp_funct(D_990114799_6_6_D_261863326_6_6,"Year Sibling 6 Stomach Cancer Diagnosed", "Year")
#boxp_funct(D_195363361_6_6_D_206625031_6_6,"Age Sibling 6 Testicular Cancer Diagnosed", "Age")
#boxp_funct(D_195363361_6_6_D_261863326_6_6,"Year Sibling 6 Testicular Cancer Diagnosed", "Year")
#boxp_funct(D_216840563_6_6_D_206625031_6_6,"Age Sibling 6 Thyroid Cancer Diagnosed", "Age")
...
#boxp_funct(D_514034680_6_6_D_261863326_6_6,"Year Sibling 6 Uterine Cancer Diagnosed", "Year") 
...
#boxp_funct(D_312545873_6_6_D_206625031_6_6,"Age Sibling 6 Unknown Cancer Diagnosed", "Age")
#boxp_funct(D_312545873_6_6_D_261863326_6_6,"Year Sibling 6 Unknown Cancer Diagnosed", "Year")
...
dt_ch1_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_ch2_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_ch3_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_ch4_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_ch5_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_ch6_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd1_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd2_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd3_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd4_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd5_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_chd6_d_age_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
# boxp_funct(module1$D_900939817_1_1_D_206625031_1_1, "Child 1 Age at Anal Cancer Diagnosis", "Age") #anal
# boxp_funct(module1$D_900939817_1_1_D_261863326_1_1, "Child 1 Year at Anal Cancer Diagnosis", "Year") #anal
# boxp_funct(module1$D_938150507_1_1_D_206625031_1_1, "Child 1 Age at Bladder Cancer Diagnosis", "Age") #bladder
# boxp_funct(module1$D_938150507_1_1_D_261863326_1_1, "Child 1 Year at Bladder Cancer Diagnosis", "Year") #bladder
# boxp_funct(module1$D_601211723_1_1_D_206625031_1_1, "Child 1 Age at Brain Cancer Diagnosis", "Age") #brain
# boxp_funct(module1$D_601211723_1_1_D_261863326_1_1, "Child 1 Year at Brain Cancer Diagnosis", "Year") #brain
# boxp_funct(module1$D_861788020_1_1_D_206625031_1_1, "Child 1 Age at Breast Cancer Diagnosis", "Age") #breast
# boxp_funct(module1$D_861788020_1_1_D_261863326_1_1, "Child 1 Year at Breast Cancer Diagnosis", "Year") #breast
# boxp_funct(module1$D_204425387_1_1_D_206625031_1_1, "Child 1 Age at Cervical Cancer Diagnosis", "Age") #cervical
# boxp_funct(module1$D_204425387_1_1_D_261863326_1_1, "Child 1 Year at Cervical Cancer Diagnosis", "Year") #cervical
# boxp_funct(module1$D_558929585_1_1_D_206625031_1_1, "Child 1 Age at Colon Cancer Diagnosis", "Age") #colon
# boxp_funct(module1$D_558929585_1_1_D_261863326_1_1, "Child 1 Year at Colon Cancer Diagnosis", "Year") #colon
# boxp_funct(module1$D_233764880_1_1_D_206625031_1_1, "Child 1 Age at Esophageal Cancer Diagnosis", "Age") #esphageal
# boxp_funct(module1$D_233764880_1_1_D_261863326_1_1, "Child 1 Year at Esophageal Cancer Diagnosis", "Year") #esphageal
# boxp_funct(module1$D_905145893_1_1_D_206625031_1_1, "Child 1 Age at Head&Neck Cancer Diagnosis", "Age")#head & neck
# boxp_funct(module1$D_905145893_1_1_D_261863326_1_1, "Child 1 Year at Head&Neck Cancer Diagnosis", "Year")#head & neck
# boxp_funct(module1$D_473190270_1_1_D_206625031_1_1, "Child 1 Age at Kidney Cancer Diagnosis", "Age")#kidney
# boxp_funct(module1$D_473190270_1_1_D_261863326_1_1, "Child 1 Year at Kidney Cancer Diagnosis", "Year")#kidney
# boxp_funct(module1$D_483735587_1_1_D_206625031_1_1, "Child 1 Age at Leukemia Cancer Diagnosis", "Age") #leuk
# boxp_funct(module1$D_483735587_1_1_D_261863326_1_1, "Child 1 Year at Leukemia Cancer Diagnosis", "Year") #leuk
# boxp_funct(module1$D_331759900_1_1_D_206625031_1_1, "Child 1 Age at Liver Cancer Diagnosis", "Age") #liver
# boxp_funct(module1$D_331759900_1_1_D_261863326_1_1, "Child 1 Year at Liver Cancer Diagnosis", "Year") #liver
# boxp_funct(module1$D_513077276_1_1_D_206625031_1_1, "Child 1 Age at Lung Cancer Diagnosis", "Age")#lung
# boxp_funct(module1$D_513077276_1_1_D_261863326_1_1, "Child 1 Year at Lung Cancer Diagnosis", "Year")#lung
# boxp_funct(module1$D_519974530_1_1_D_206625031_1_1, "Child 1 Age at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Age") #nonH
# boxp_funct(module1$D_519974530_1_1_D_261863326_1_1, "Child 1 Year at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Year") #nonH
# boxp_funct(module1$D_907776050_1_1_D_206625031_1_1, "Child 1 Age at Lymphoma Cancer Diagnosis", "Age") #lymphoma
# boxp_funct(module1$D_907776050_1_1_D_261863326_1_1, "Child 1 Year at Lymphoma Cancer Diagnosis", "Year") #lymphoma
# boxp_funct(module1$D_271684775_1_1_D_206625031_1_1, "Child 1 Age at Melanoma Cancer Diagnosis", "Age") #mel
# boxp_funct(module1$D_271684775_1_1_D_261863326_1_1, "Child 1 Year at Melanoma Cancer Diagnosis", "Year") #mel
# boxp_funct(module1$D_252160589_1_1_D_206625031_1_1, "Child 1 Age at Non-Melanoma Cancer Diagnosis", "Age") #non-mel
# boxp_funct(module1$D_252160589_1_1_D_261863326_1_1, "Child 1 Year at Non-Melanoma Cancer Diagnosis", "Year") #non-mel
# boxp_funct(module1$D_774774759_1_1_D_206625031_1_1, "Child 1 Age Ovarian Cancer Diagnosis", "Age") #ovarian
# boxp_funct(module1$D_774774759_1_1_D_261863326_1_1, "Child 1 Year at Ovarian Cancer Diagnosis", "Year") #ovarian
# boxp_funct(module1$D_127257956_1_1_D_206625031_1_1, "Child 1 Age at Pancreatic Cancer Diagnosis", "Age") #pancreatic
# boxp_funct(module1$D_127257956_1_1_D_261863326_1_1, "Child 1 Year at Pancreatic Cancer Diagnosis", "Year") #pancreatic
# boxp_funct(module1$D_496917282_1_1_D_206625031_1_1, "Child 1 Age at Prostate Cancer Diagnosis", "Age") #prostate
# boxp_funct(module1$D_496917282_1_1_D_261863326_1_1, "Child 1 Year at Prostate Cancer Diagnosis", "Year") #prostate
# boxp_funct(module1$D_908129316_1_1_D_206625031_1_1, "Child 1 Age at Stomach Cancer Diagnosis", "Age") #stomach
# boxp_funct(module1$D_908129316_1_1_D_261863326_1_1, "Child 1 Year at Stomach Cancer Diagnosis", "Year") #stomach
# boxp_funct(module1$D_795003496_1_1_D_206625031_1_1, "Child 1 Age at Testicular Cancer Diagnosis", "Age") #testicular
# boxp_funct(module1$D_795003496_1_1_D_261863326_1_1, "Child 1 Year at Testicular Cancer Diagnosis", "Year") #testicular
# boxp_funct(module1$D_969177591_1_1_D_206625031_1_1, "Child 1 Age at Thyroid Cancer Diagnosis", "Age") #thyroid
# boxp_funct(module1$D_969177591_1_1_D_261863326_1_1, "Child 1 Year at Thyroid Cancer Diagnosis", "Year") #thyroid
# boxp_funct(module1$D_116065851_1_1_D_206625031_1_1, "Child 1 Age at Urine Cancer Diagnosis", "Age") #urine
# boxp_funct(module1$D_116065851_1_1_D_261863326_1_1, "Child 1 Year at Urine Cancer Diagnosis", "Year") #urine
# boxp_funct(module1$D_278159347_1_1_D_206625031_1_1, "Child 1 Age at Other Cancer Diagnosis", "Age") #other
# boxp_funct(module1$D_278159347_1_1_D_261863326_1_1, "Child 1 Year at Other Cancer Diagnosis", "Year") #other
# boxp_funct(module1$D_845219872_1_1_D_206625031_1_1, "Child 1 Age at Unknown Cancer Diagnosis", "Age")#unknown
# boxp_funct(module1$D_845219872_1_1_D_261863326_1_1, "Child 1 Year at Unknown Cancer Diagnosis", "Year") #unknown
# 
# 
# boxp_funct(module1$D_900939817_2_2_D_206625031_2_2, "Child 2 Age at Anal Cancer Diagnosis", "Age") #anal
# boxp_funct(module1$D_900939817_2_2_D_261863326_2_2, "Child 2 Year at Anal Cancer Diagnosis", "Year") #anal
# boxp_funct(module1$D_938150507_2_2_D_206625031_2_2, "Child 2 Age at Bladder Cancer Diagnosis", "Age") #bladder
# boxp_funct(module1$D_938150507_2_2_D_261863326_2_2, "Child 2 Year at Bladder Cancer Diagnosis", "Year") #bladder
# boxp_funct(module1$D_601211723_2_2_D_206625031_2_2, "Child 2 Age at Brain Cancer Diagnosis", "Age") #brain
# boxp_funct(module1$D_601211723_2_2_D_261863326_2_2, "Child 2 Year at Brain Cancer Diagnosis", "Year") #brain
# boxp_funct(module1$D_861788020_2_2_D_206625031_2_2, "Child 2 Age at Breast Cancer Diagnosis", "Age") #breast
# boxp_funct(module1$D_861788020_2_2_D_261863326_2_2, "Child 2 Year at Breast Cancer Diagnosis", "Year") #breast
# boxp_funct(module1$D_204425387_2_2_D_206625031_2_2, "Child 2 Age at Cervical Cancer Diagnosis", "Age") #cervical
# boxp_funct(module1$D_204425387_2_2_D_261863326_2_2, "Child 2 Year at Cervical Cancer Diagnosis", "Year") #cervical
# boxp_funct(module1$D_558929585_2_2_D_206625031_2_2, "Child 2 Age at Colon Cancer Diagnosis", "Age") #colon
# boxp_funct(module1$D_558929585_2_2_D_261863326_2_2, "Child 2 Year at Colon Cancer Diagnosis", "Year") #colon
# boxp_funct(module1$D_233764880_2_2_D_206625031_2_2, "Child 2 Age at Esophageal Cancer Diagnosis", "Age") #esphageal
# boxp_funct(module1$D_233764880_2_2_D_261863326_2_2, "Child 2 Year at Esophageal Cancer Diagnosis", "Year") #esphageal
# boxp_funct(module1$D_905145893_2_2_D_206625031_2_2, "Child 2 Age at Head&Neck Cancer Diagnosis", "Age")#head & neck
# boxp_funct(module1$D_905145893_2_2_D_261863326_2_2, "Child 2 Year at Head&Neck Cancer Diagnosis", "Year")#head & neck
# boxp_funct(module1$D_473190270_2_2_D_206625031_2_2, "Child 2 Age at Kidney Cancer Diagnosis", "Age")#kidney
# boxp_funct(module1$D_473190270_2_2_D_261863326_2_2, "Child 2 Year at Kidney Cancer Diagnosis", "Year")#kidney
# boxp_funct(module1$D_483735587_2_2_D_206625031_2_2, "Child 2 Age at Leukemia Cancer Diagnosis", "Age") #leuk
# boxp_funct(module1$D_483735587_2_2_D_261863326_2_2, "Child 2 Year at Leukemia Cancer Diagnosis", "Year") #leuk
# boxp_funct(module1$D_331759900_2_2_D_206625031_2_2, "Child 2 Age at Liver Cancer Diagnosis", "Age") #liver
# boxp_funct(module1$D_331759900_2_2_D_261863326_2_2, "Child 2 Year at Liver Cancer Diagnosis", "Year") #liver
# boxp_funct(module1$D_513077276_2_2_D_206625031_2_2, "Child 2 Age at Lung Cancer Diagnosis", "Age")#lung
# boxp_funct(module1$D_513077276_2_2_D_261863326_2_2, "Child 2 Year at Lung Cancer Diagnosis", "Year")#lung
# boxp_funct(module1$D_519974530_2_2_D_206625031_2_2, "Child 2 Age at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Age") #nonH
# boxp_funct(module1$D_519974530_2_2_D_261863326_2_2, "Child 2 Year at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Year") #nonH
# boxp_funct(module1$D_907776050_2_2_D_206625031_2_2, "Child 2 Age at Lymphoma Cancer Diagnosis", "Age") #lymphoma
# boxp_funct(module1$D_907776050_2_2_D_261863326_2_2, "Child 2 Year at Lymphoma Cancer Diagnosis", "Year") #lymphoma
# boxp_funct(module1$D_271684775_2_2_D_206625031_2_2, "Child 2 Age at Melanoma Cancer Diagnosis", "Age") #mel
# boxp_funct(module1$D_271684775_2_2_D_261863326_2_2, "Child 2 Year at Melanoma Cancer Diagnosis", "Year") #mel
# boxp_funct(module1$D_252160589_2_2_D_206625031_2_2, "Child 2 Age at Non-Melanoma Cancer Diagnosis", "Age") #non-mel
# boxp_funct(module1$D_252160589_2_2_D_261863326_2_2, "Child 2 Year at Non-Melanoma Cancer Diagnosis", "Year") #non-mel
# boxp_funct(module1$D_774774759_2_2_D_206625031_2_2, "Child 2 Age Ovarian Cancer Diagnosis", "Age") #ovarian
# boxp_funct(module1$D_774774759_2_2_D_261863326_2_2, "Child 2 Year at Ovarian Cancer Diagnosis", "Year") #ovarian
# boxp_funct(module1$D_127257956_2_2_D_206625031_2_2, "Child 2 Age at Pancreatic Cancer Diagnosis", "Age") #pancreatic
# boxp_funct(module1$D_127257956_2_2_D_261863326_2_2, "Child 2 Year at Pancreatic Cancer Diagnosis", "Year") #pancreatic
# boxp_funct(module1$D_496917282_2_2_D_206625031_2_2, "Child 2 Age at Prostate Cancer Diagnosis", "Age") #prostate
# boxp_funct(module1$D_496917282_2_2_D_261863326_2_2, "Child 2 Year at Prostate Cancer Diagnosis", "Year") #prostate
# boxp_funct(module1$D_908129316_2_2_D_206625031_2_2, "Child 2 Age at Stomach Cancer Diagnosis", "Age") #stomach
# boxp_funct(module1$D_908129316_2_2_D_261863326_2_2, "Child 2 Year at Stomach Cancer Diagnosis", "Year") #stomach
# boxp_funct(module1$D_795003496_2_2_D_206625031_2_2, "Child 2 Age at Testicular Cancer Diagnosis", "Age") #testicular
# boxp_funct(module1$D_795003496_2_2_D_261863326_2_2, "Child 2 Year at Testicular Cancer Diagnosis", "Year") #testicular
# boxp_funct(module1$D_969177591_2_2_D_206625031_2_2, "Child 2 Age at Thyroid Cancer Diagnosis", "Age") #thyroid
# boxp_funct(module1$D_969177591_2_2_D_261863326_2_2, "Child 2 Year at Thyroid Cancer Diagnosis", "Year") #thyroid
# boxp_funct(module1$D_116065851_2_2_D_206625031_2_2, "Child 2 Age at Urine Cancer Diagnosis", "Age") #urine
# boxp_funct(module1$D_116065851_2_2_D_261863326_2_2, "Child 2 Year at Urine Cancer Diagnosis", "Year") #urine
# boxp_funct(module1$D_278159347_2_2_D_206625031_2_2, "Child 2 Age at Other Cancer Diagnosis", "Age") #other
# boxp_funct(module1$D_278159347_2_2_D_261863326_2_2, "Child 2 Year at Other Cancer Diagnosis", "Year") #other
# boxp_funct(module1$D_845219872_2_2_D_206625031_2_2, "Child 2 Age at Unknown Cancer Diagnosis", "Age")#unknown
# boxp_funct(module1$D_845219872_2_2_D_261863326_2_2, "Child 2 Year at Unknown Cancer Diagnosis", "Year") #unknown
# 
# 
# boxp_funct(module1$D_900939817_3_3_D_206625031_3_3, "Child 3 Age at Anal Cancer Diagnosis", "Age") #anal
# boxp_funct(module1$D_900939817_3_3_D_261863326_3_3, "Child 3 Year at Anal Cancer Diagnosis", "Year") #anal
# boxp_funct(module1$D_938150507_3_3_D_206625031_3_3, "Child 3 Age at Bladder Cancer Diagnosis", "Age") #bladder
# boxp_funct(module1$D_938150507_3_3_D_261863326_3_3, "Child 3 Year at Bladder Cancer Diagnosis", "Year") #bladder
# boxp_funct(module1$D_601211723_3_3_D_206625031_3_3, "Child 3 Age at Brain Cancer Diagnosis", "Age") #brain
# boxp_funct(module1$D_601211723_3_3_D_261863326_3_3, "Child 3 Year at Brain Cancer Diagnosis", "Year") #brain
# boxp_funct(module1$D_861788020_3_3_D_206625031_3_3, "Child 3 Age at Breast Cancer Diagnosis", "Age") #breast
# boxp_funct(module1$D_861788020_3_3_D_261863326_3_3, "Child 3 Year at Breast Cancer Diagnosis", "Year") #breast
# boxp_funct(module1$D_204425387_3_3_D_206625031_3_3, "Child 3 Age at Cervical Cancer Diagnosis", "Age") #cervical
# boxp_funct(module1$D_204425387_3_3_D_261863326_3_3, "Child 3 Year at Cervical Cancer Diagnosis", "Year") #cervical
# boxp_funct(module1$D_558929585_3_3_D_206625031_3_3, "Child 3 Age at Colon Cancer Diagnosis", "Age") #colon
# boxp_funct(module1$D_558929585_3_3_D_261863326_3_3, "Child 3 Year at Colon Cancer Diagnosis", "Year") #colon
# boxp_funct(module1$D_233764880_3_3_D_206625031_3_3, "Child 3 Age at Esophageal Cancer Diagnosis", "Age") #esphageal
# boxp_funct(module1$D_233764880_3_3_D_261863326_3_3, "Child 3 Year at Esophageal Cancer Diagnosis", "Year") #esphageal
# boxp_funct(module1$D_905145893_3_3_D_206625031_3_3, "Child 3 Age at Head&Neck Cancer Diagnosis", "Age")#head & neck
# boxp_funct(module1$D_905145893_3_3_D_261863326_3_3, "Child 3 Year at Head&Neck Cancer Diagnosis", "Year")#head & neck
# boxp_funct(module1$D_473190270_3_3_D_206625031_3_3, "Child 3 Age at Kidney Cancer Diagnosis", "Age")#kidney
# boxp_funct(module1$D_473190270_3_3_D_261863326_3_3, "Child 3 Year at Kidney Cancer Diagnosis", "Year")#kidney
# boxp_funct(module1$D_483735587_3_3_D_206625031_3_3, "Child 3 Age at Leukemia Cancer Diagnosis", "Age") #leuk
# boxp_funct(module1$D_483735587_3_3_D_261863326_3_3, "Child 3 Year at Leukemia Cancer Diagnosis", "Year") #leuk
# boxp_funct(module1$D_331759900_3_3_D_206625031_3_3, "Child 3 Age at Liver Cancer Diagnosis", "Age") #liver
# boxp_funct(module1$D_331759900_3_3_D_261863326_3_3, "Child 3 Year at Liver Cancer Diagnosis", "Year") #liver
# boxp_funct(module1$D_513077276_3_3_D_206625031_3_3, "Child 3 Age at Lung Cancer Diagnosis", "Age")#lung
# boxp_funct(module1$D_513077276_3_3_D_261863326_3_3, "Child 3 Year at Lung Cancer Diagnosis", "Year")#lung
# boxp_funct(module1$D_519974530_3_3_D_206625031_3_3, "Child 3 Age at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Age") #nonH
# boxp_funct(module1$D_519974530_3_3_D_261863326_3_3, "Child 3 Year at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Year") #nonH
# boxp_funct(module1$D_907776050_3_3_D_206625031_3_3, "Child 3 Age at Lymphoma Cancer Diagnosis", "Age") #lymphoma
# boxp_funct(module1$D_907776050_3_3_D_261863326_3_3, "Child 3 Year at Lymphoma Cancer Diagnosis", "Year") #lymphoma
# boxp_funct(module1$D_271684775_3_3_D_206625031_3_3, "Child 3 Age at Melanoma Cancer Diagnosis", "Age") #mel
# boxp_funct(module1$D_271684775_3_3_D_261863326_3_3, "Child 3 Year at Melanoma Cancer Diagnosis", "Year") #mel
# boxp_funct(module1$D_252160589_3_3_D_206625031_3_3, "Child 3 Age at Non-Melanoma Cancer Diagnosis", "Age") #non-mel
# boxp_funct(module1$D_252160589_3_3_D_261863326_3_3, "Child 3 Year at Non-Melanoma Cancer Diagnosis", "Year") #non-mel
# boxp_funct(module1$D_774774759_3_3_D_206625031_3_3, "Child 3 Age Ovarian Cancer Diagnosis", "Age") #ovarian
# boxp_funct(module1$D_774774759_3_3_D_261863326_3_3, "Child 3 Year at Ovarian Cancer Diagnosis", "Year") #ovarian
# boxp_funct(module1$D_127257956_3_3_D_206625031_3_3, "Child 3 Age at Pancreatic Cancer Diagnosis", "Age") #pancreatic
# boxp_funct(module1$D_127257956_3_3_D_261863326_3_3, "Child 3 Year at Pancreatic Cancer Diagnosis", "Year") #pancreatic
# boxp_funct(module1$D_496917282_3_3_D_206625031_3_3, "Child 3 Age at Prostate Cancer Diagnosis", "Age") #prostate
# boxp_funct(module1$D_496917282_3_3_D_261863326_3_3, "Child 3 Year at Prostate Cancer Diagnosis", "Year") #prostate
# boxp_funct(module1$D_908129316_3_3_D_206625031_3_3, "Child 3 Age at Stomach Cancer Diagnosis", "Age") #stomach
# boxp_funct(module1$D_908129316_3_3_D_261863326_3_3, "Child 3 Year at Stomach Cancer Diagnosis", "Year") #stomach
# boxp_funct(module1$D_795003496_3_3_D_206625031_3_3, "Child 3 Age at Testicular Cancer Diagnosis", "Age") #testicular
# boxp_funct(module1$D_795003496_3_3_D_261863326_3_3, "Child 3 Year at Testicular Cancer Diagnosis", "Year") #testicular
# boxp_funct(module1$D_969177591_3_3_D_206625031_3_3, "Child 3 Age at Thyroid Cancer Diagnosis", "Age") #thyroid
# boxp_funct(module1$D_969177591_3_3_D_261863326_3_3, "Child 3 Year at Thyroid Cancer Diagnosis", "Year") #thyroid
# boxp_funct(module1$D_116065851_3_3_D_206625031_3_3, "Child 3 Age at Urine Cancer Diagnosis", "Age") #urine
# boxp_funct(module1$D_116065851_3_3_D_261863326_3_3, "Child 3 Year at Urine Cancer Diagnosis", "Year") #urine
# boxp_funct(module1$D_278159347_3_3_D_206625031_3_3, "Child 3 Age at Other Cancer Diagnosis", "Age") #other
# boxp_funct(module1$D_278159347_3_3_D_261863326_3_3, "Child 3 Year at Other Cancer Diagnosis", "Year") #other
# boxp_funct(module1$D_845219872_3_3_D_206625031_3_3, "Child 3 Age at Unknown Cancer Diagnosis", "Age")#unknown
# boxp_funct(module1$D_845219872_3_3_D_261863326_3_3, "Child 3 Year at Unknown Cancer Diagnosis", "Year") #unknown
# 
# 
# boxp_funct(module1$D_900939817_4_4_D_206625031_4_4, "Child 4 Age at Anal Cancer Diagnosis", "Age") #anal
# boxp_funct(module1$D_900939817_4_4_D_261863326_4_4, "Child 4 Year at Anal Cancer Diagnosis", "Year") #anal
# boxp_funct(module1$D_938150507_4_4_D_206625031_4_4, "Child 4 Age at Bladder Cancer Diagnosis", "Age") #bladder
# boxp_funct(module1$D_938150507_4_4_D_261863326_4_4, "Child 4 Year at Bladder Cancer Diagnosis", "Year") #bladder
# boxp_funct(module1$D_601211723_4_4_D_206625031_4_4, "Child 4 Age at Brain Cancer Diagnosis", "Age") #brain
# boxp_funct(module1$D_601211723_4_4_D_261863326_4_4, "Child 4 Year at Brain Cancer Diagnosis", "Year") #brain
# boxp_funct(module1$D_861788020_4_4_D_206625031_4_4, "Child 4 Age at Breast Cancer Diagnosis", "Age") #breast
# boxp_funct(module1$D_861788020_4_4_D_261863326_4_4, "Child 4 Year at Breast Cancer Diagnosis", "Year") #breast
# boxp_funct(module1$D_204425387_4_4_D_206625031_4_4, "Child 4 Age at Cervical Cancer Diagnosis", "Age") #cervical
# boxp_funct(module1$D_204425387_4_4_D_261863326_4_4, "Child 4 Year at Cervical Cancer Diagnosis", "Year") #cervical
# boxp_funct(module1$D_558929585_4_4_D_206625031_4_4, "Child 4 Age at Colon Cancer Diagnosis", "Age") #colon
# boxp_funct(module1$D_558929585_4_4_D_261863326_4_4, "Child 4 Year at Colon Cancer Diagnosis", "Year") #colon
# boxp_funct(module1$D_233764880_4_4_D_206625031_4_4, "Child 4 Age at Esophageal Cancer Diagnosis", "Age") #esphageal
# boxp_funct(module1$D_233764880_4_4_D_261863326_4_4, "Child 4 Year at Esophageal Cancer Diagnosis", "Year") #esphageal
# boxp_funct(module1$D_905145893_4_4_D_206625031_4_4, "Child 4 Age at Head&Neck Cancer Diagnosis", "Age")#head & neck
# boxp_funct(module1$D_905145893_4_4_D_261863326_4_4, "Child 4 Year at Head&Neck Cancer Diagnosis", "Year")#head & neck
# boxp_funct(module1$D_473190270_4_4_D_206625031_4_4, "Child 4 Age at Kidney Cancer Diagnosis", "Age")#kidney
# boxp_funct(module1$D_473190270_4_4_D_261863326_4_4, "Child 4 Year at Kidney Cancer Diagnosis", "Year")#kidney
# boxp_funct(module1$D_483735587_4_4_D_206625031_4_4, "Child 4 Age at Leukemia Cancer Diagnosis", "Age") #leuk
# boxp_funct(module1$D_483735587_4_4_D_261863326_4_4, "Child 4 Year at Leukemia Cancer Diagnosis", "Year") #leuk
# boxp_funct(module1$D_331759900_4_4_D_206625031_4_4, "Child 4 Age at Liver Cancer Diagnosis", "Age") #liver
# boxp_funct(module1$D_331759900_4_4_D_261863326_4_4, "Child 4 Year at Liver Cancer Diagnosis", "Year") #liver
# boxp_funct(module1$D_513077276_4_4_D_206625031_4_4, "Child 4 Age at Lung Cancer Diagnosis", "Age")#lung
# boxp_funct(module1$D_513077276_4_4_D_261863326_4_4, "Child 4 Year at Lung Cancer Diagnosis", "Year")#lung
# boxp_funct(module1$D_519974530_4_4_D_206625031_4_4, "Child 4 Age at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Age") #nonH
# boxp_funct(module1$D_519974530_4_4_D_261863326_4_4, "Child 4 Year at Non-Hodgkin's Lymphoma Cancer Diagnosis", "Year") #nonH
# boxp_funct(module1$D_907776050_4_4_D_206625031_4_4, "Child 4 Age at Lymphoma Cancer Diagnosis", "Age") #lymphoma
# boxp_funct(module1$D_907776050_4_4_D_261863326_4_4, "Child 4 Year at Lymphoma Cancer Diagnosis", "Year") #lymphoma
# boxp_funct(module1$D_271684775_4_4_D_206625031_4_4, "Child 4 Age at Melanoma Cancer Diagnosis", "Age") #mel
# boxp_funct(module1$D_271684775_4_4_D_261863326_4_4, "Child 4 Year at Melanoma Cancer Diagnosis", "Year") #mel
# boxp_funct(module1$D_252160589_4_4_D_206625031_4_4, "Child 4 Age at Non-Melanoma Cancer Diagnosis", "Age") #non-mel
# boxp_funct(module1$D_252160589_4_4_D_261863326_4_4, "Child 4 Year at Non-Melanoma Cancer Diagnosis", "Year") #non-mel
# boxp_funct(module1$D_774774759_4_4_D_206625031_4_4, "Child 4 Age Ovarian Cancer Diagnosis", "Age") #ovarian
# boxp_funct(module1$D_774774759_4_4_D_261863326_4_4, "Child 4 Year at Ovarian Cancer Diagnosis", "Year") #ovarian
# boxp_funct(module1$D_127257956_4_4_D_206625031_4_4, "Child 4 Age at Pancreatic Cancer Diagnosis", "Age") #pancreatic
# boxp_funct(module1$D_127257956_4_4_D_261863326_4_4, "Child 4 Year at Pancreatic Cancer Diagnosis", "Year") #pancreatic
# boxp_funct(module1$D_496917282_4_4_D_206625031_4_4, "Child 4 Age at Prostate Cancer Diagnosis", "Age") #prostate
# boxp_funct(module1$D_496917282_4_4_D_261863326_4_4, "Child 4 Year at Prostate Cancer Diagnosis", "Year") #prostate
# boxp_funct(module1$D_908129316_4_4_D_206625031_4_4, "Child 4 Age at Stomach Cancer Diagnosis", "Age") #stomach
# boxp_funct(module1$D_908129316_4_4_D_261863326_4_4, "Child 4 Year at Stomach Cancer Diagnosis", "Year") #stomach
# boxp_funct(module1$D_795003496_4_4_D_206625031_4_4, "Child 4 Age at Testicular Cancer Diagnosis", "Age") #testicular
# boxp_funct(module1$D_795003496_4_4_D_261863326_4_4, "Child 4 Year at Testicular Cancer Diagnosis", "Year") #testicular
# boxp_funct(module1$D_969177591_4_4_D_206625031_4_4, "Child 4 Age at Thyroid Cancer Diagnosis", "Age") #thyroid
# boxp_funct(module1$D_969177591_4_4_D_261863326_4_4, "Child 4 Year at Thyroid Cancer Diagnosis", "Year") #thyroid
# boxp_funct(module1$D_116065851_4_4_D_206625031_4_4, "Child 4 Age at Urine Cancer Diagnosis", "Age") #urine
# boxp_funct(module1$D_116065851_4_4_D_261863326_4_4, "Child 4 Year at Urine Cancer Diagnosis", "Year") #urine
# boxp_funct(module1$D_278159347_4_4_D_206625031_4_4, "Child 4 Age at Other Cancer Diagnosis", "Age") #other
# boxp_funct(module1$D_278159347_4_4_D_261863326_4_4, "Child 4 Year at Other Cancer Diagnosis", "Year") #other
# boxp_funct(module1$D_845219872_4_4_D_206625031_4_4, "Child 4 Age at Unknown Cancer Diagnosis", "Age")#unknown
# boxp_funct(module1$D_845219872_4_4_D_261863326_4_4, "Child 4 Year at Unknown Cancer Diagnosis", "Year") #unknown
...
#In school now?
dict <- c(dict, "551525967"="Yes, Full-Time Student", "738284740"="Yes, Part Time Student")
...
#work status
dict <- c(dict, "584368278"="Retired", "475665841"="Homemaker", "656816477"="Unemployed", "756948639"="Unble to Work (Disabled)", "181769837"="Other Employment Status", "746038746"="Prefer Not to Answer")
simple_funct(D_114529380, "WORK2: Employment Status")

#current title
#table(module1$D_627122657)-- potentially pii and VERY long with all individual responses 
home1skip <- data_tib_m1 %>% select(D_761310265)
...
home1skip <- data_tib_m1 %>% select(D_434316600)
...
dt_curr_bus= data_tib_m1 %>% filter(D_613744428=="353358909")
...
home1skip <- data_tib_m1 %>% select(D_868232409)
...
simple_funct(D_847533056, "WORK5: Current Job the Longest Held Job")


#ever worked for pay?
simple_funct(D_403258164, "WORK6: Ever Work")
...
home1skip <- data_tib_m1 %>% filter(D_403258164==353358909 | D_847533056!=353358909) %>% select(D_279637054)
...
home1skip <- data_tib_m1 %>% filter(D_403258164==353358909 | D_847533056!=353358909) %>% select(D_988878019)
...
#table(module1$D_233198706) -- potentially identifying? And VERY LONG with individual reponses
 home1skip <- data_tib_m1 %>% filter(D_403258164==353358909 | D_847533056!=353358909) %>% select(D_233198706)

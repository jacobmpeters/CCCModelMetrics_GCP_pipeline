...
home1skip <- data_tib_m1 %>% select(D_761310265)  %>%  filter(data_tib_m1$D_613744428==353358909)
...
home1skip <- data_tib_m1 %>% select(D_434316600)  %>%  filter(data_tib_m1$D_613744428==353358909)
...
dt_curr_bus= data_tib_m1 %>% filter(D_613744428=="353358909")  %>%  filter(data_tib_m1$D_613744428==353358909)
...
home1skip <- data_tib_m1 %>% select(D_868232409) %>%  filter(data_tib_m1$D_613744428==353358909)

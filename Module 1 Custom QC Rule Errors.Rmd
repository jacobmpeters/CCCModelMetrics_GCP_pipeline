...
parts <- "SELECT Connect_ID, token, D_512820379, D_471593703, state_d_934298480, D_230663853,d_949302066,d_536735468,d_976570371,d_663265240,
...
alt_mb <- alt_mobile %>% filter(!is.na(alt_mobile$mobile) & nchar(alt_mobile$mobile)!=10) %>% 
  select(Site, Connect_ID, mobile ) %>%  group_by(Site)
...
alt_home <- alt_home %>% filter(!is.na(alt_home$home) & nchar(alt_home$home)!=10) %>% 
  select(Site, Connect_ID, home ) %>%  group_by(Site)
...
zipcode <- module1 %>% filter(!is.na(module1$zip_num) & nchar(module1$zip_num)!=0 & nchar(module1$zip_num)!=5 & nchar(module1$zip_num)!=9) %>% 
  select(Site, Connect_ID, zip_num) %>%  group_by(Site)
...
knitr::kable(zipcode)  %>% kable_styling(latex_options = "HOLD_position")

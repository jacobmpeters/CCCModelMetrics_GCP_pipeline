...
#Num2_M1=
  ...
  cols_label(status = md("**Completion Status**"), freq.Active = md("**Number of \nparticipants (n)**"), freq.Passive = md("**Number of \nparticipants (n)**"), 
             freq = md("**Total Number \nof participants (N)**"), 
             percentage.Active = md("**Percentage \nof Participants**"), percentage.Passive = md("**Percentage \nof Participants**"), percentage= md("**Percentage \nof Participants**")) %>% 
               tab_footnote(
...
#knitr::kable(as.data.frame(Num2_M1[,c(1:8)]),caption='Module 1 Completion Status of Verified Participants (Before)',align=c("l", "c", "c","c", "c","c","c"), booktabs = TRUE) %>% add_header_above(c(" "=2, "Total" = 2, "Active" = 2,"Passive"=2))
...
prts_ccc <- "SELECT Connect_ID,  d_265193023,  d_459098666 from `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP`"

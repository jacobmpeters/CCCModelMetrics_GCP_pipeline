...
ccc1=modules1 %>% mutate(freq=rep(1, dim(modules1)[[1]]))
head(ccc1)
dim(ccc1)[[1]]
...
dt_summary %>%  gt() %>%  
  ...
  tab_footnote(
    footnote = "This includes impossible scenarios: Sections LAW, MRE, and/or SAS being completed without BOH Section first completed. Only scenarios that have occured will show on this table.") %>%
  cols_label(process = md("**Sections Completed**"), freq = md("**Number of participants (n)**"), percentage = md("**Percentage of Participants**")) %>% 
  summary_rows(
    columns = c(freq, percentage),
    fns= list(
      Sum= ~sum(.)
...
#summary(as.numeric(tmp3A$Mod3completionA))
st(tmp3A, vars = c('Mod3completionA', title='Table 3j. SAS Active (After)'))


#cat("Passive(n=", dim(pas3)[[1]], ")")
#summary(as.numeric(Ptmp3A$Mod3completionP))
st(Ptmp3A, vars = c('Mod3completionP', title='Table 3k. SAS Passive (After)'))


#cat("Total(n=", dim(mer3)[[1]], ")")
#summary(as.numeric(Ttmp3T$Mod3completionT))
st(Ttmp3T, vars = c('Mod3completionT', title='Table 3l. SAS Total (After)'))
```
...
#summary(as.numeric(tmp4A$Mod4completionA))
st(tmp4A, vars = c('Mod4completionA', title='Table 3m. LAW Active (After)'))

#cat("Passive(n=", dim(pas4)[[1]], ")")
#summary(as.numeric(Ptmp4A$Mod4completionP))
st(Ptmp4A, vars = c('Mod4completionP', title='Table 3n. LAW Passive (After)'))

#cat("Total(n=", dim(mer4)[[1]], ")")
#summary(as.numeric(Ttmp4$Mod4completionT))
st(Ttmp4, vars = c('Mod4completionT', title='Table 3o. LAW Total (After)'))
...
#cat("Active(n=", s4_1bA, ")")
#summary(as.numeric(Atmp1$Mod1completionA))
st(Atmp1, vars = c('Mod1completionA', title='Table 4a. BOH Active (Before)', add.median = T))

#cat("Passive(n=", s4_1bP, ")")
#summary(Ptmp1$Mod1completionP)
st(Ptmp1, vars = c('Mod1completionP', title='Table 4b. BOH Passive (Before)', add.median = T))

#cat("Total(n=", s4_1bT, ")")
#summary(as.numeric(Ttmp1$Mod1completionT))
st(Ttmp1, vars = c('Mod1completionT', title='Table 4c. BOH Total (Before)', add.median = T))
...
#cat("Active(n=", s4_1aA, ")")
#summary(as.numeric(Atmp1$Mod1completionA))
st(Atmp1, vars = c('Mod1completionA', title='Table 4e. BOH Active (After)', add.median = T))

#cat("Passive(n=", s4_1aP, ")")
#summary(Ptmp1$Mod1completionP)
st(Ptmp1, vars = c('Mod1completionP', title='Table 4f. BOH Passive (After)', add.median = T))

#cat("Total(n=", s4_1aT, ")")
#summary(as.numeric(Ttmp1a$Mod1completionT.A))
st(Ttmp1a, vars = c('Mod1completionT.A', title='Table 4g. BOH Total (After)', add.median = T))
...
#summary(as.numeric(Atmp1$Mod1completionA))
st(Atmp1, vars = c('Mod1completionA', title='Table 5a. All BOH Active', add.median = T))

#summary(Ptmp1$Mod1completionP)
st(Ptmp1, vars = c('Mod1completionP', title='Table 5b. All BOH Passive', add.median = T))
...
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
ccc4_all_1_summary %>%  gt() %>%  
  fmt_number(columns = "percentage.Active", decimals = 2) %>% 
  fmt_number(columns = "percentage.Passive", decimals = 2) %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
  tab_header(title = html("Table 5d. BOH Section Completion Time of All Verified Participants")) %>% 
  cols_label(time_frame = md("**Completion Time**"), freq.Active = md("**(N)**"), freq.Passive = md("**(N)**"), 
             freq = md("**(N)**"), 
             percentage.Active = md("**%**"), percentage.Passive = md("**%**"), percentage= md("**%**")) %>% 
  tab_spanner(
...
#cat("Active(n=", s4_2bA, ")")
#summary(as.numeric(tmp$Mod2completionA))
st(tmp, vars = c('Mod2completionA', title='Table 6a. MRE Active (Before)', add.median = T))

#cat("Passive(n=", s4_2bP, ")")
#summary(as.numeric(ptmp$Mod2completionP))
st(ptmp, vars = c('Mod2completionP', title='Table 6b. MRE Passive (Before)', add.median = T))

#cat("Total(n=", s4_2bT, ")")
#summary(as.numeric(Ttmp2$Mod2completionT.B))
st(Ttmp2, vars = c('Mod2completionT.B', title='Table 6c. MRE Total (Before)', add.median = T))
...
#cat("Active(n=", s4_2aA, ")")
#summary(as.numeric(tmp$Mod2completionA))
st(tmp, vars = c('Mod2completionA', title='Table 6e. MRE Active (After)', add.median = T))

#cat("Passive(n=", s4_2aP, ")")
#summary(as.numeric(ptmp$Mod2completionP))
st(ptmp, vars = c('Mod2completionP', title='Table 6f. MRE Passive (After)', add.median = T))

#cat("Total(n=", s4_2aT, ")")
#summary(as.numeric(Ttmp2A$Mod2completionT.A))
st(Ttmp2A, vars = c('Mod2completionT.A', title='Table 6g. MRE Total (After)', add.median = T))
```
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
...
#summary(as.numeric(tmp$Mod2completionA))
st(tmp, vars = c('Mod2completionA', title='Table 7a. All MRE Active Participants', add.median = T))

#summary(as.numeric(ptmp$Mod2completionP))
st(ptmp, vars = c('Mod2completionP', title='Table 7b. All MRE Passive Participants', add.median = T))
...
ccc4_all_2_summary %>%  gt() %>%  
  fmt_number(columns = "percentage.Active", decimals = 2) %>% 
  fmt_number(columns = "percentage.Passive", decimals = 2) %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
  tab_header(title = html("Table 7d. MRE Section Completion Time of All Verified Participants")) %>% 
  cols_label(time_frame = md("**Completion Time**"), freq.Active = md("**(N)**"), freq.Passive = md("**(N)**"), 
             freq = md("**(N)**"), 
             percentage.Active = md("**%**"), percentage.Passive = md("**%**"), percentage= md("**%**")) %>% 
  tab_spanner(
...
#cat("Active(n=", s4_3bA, ")")
#summary(as.numeric(tmp.3A$Mod3completionA))
st(tmp.3A, vars = c('Mod3completionA', title='Table 8a. SAS Active (Before)', add.median = T))

#cat("Passive(n=", s4_3bP, ")")
#summary(as.numeric(ptmp3$Mod3completionP))
st(ptmp3, vars = c('Mod3completionP', title='Table 8b. SAS Passive (Before)', add.median = T))

#cat("Total(n=", s4_3bT, ")")
#summary(as.numeric(Ttmp3$Mod3completionT.B))
st(Ttmp3, vars = c('Mod3completionT.B', title='Table 8c. SAS Total (Before)', add.median = T))
...
#summary(as.numeric(tmp.3A$Mod3completionA))
#cat("Active(n=", s4_3aA, ")")
st(tmp.3A, vars = c('Mod3completionA', title='Table 8e. SAS Active (After)', add.median = T))

#summary(as.numeric(ptmp3$Mod3completionP))
#cat("Passive(n=", s4_3aP, ")")
st(ptmp3, vars = c('Mod3completionP', title='Table 8f. SAS Passice (After)', add.median = T))

#summary(as.numeric(Ttmp3A$Mod3completionT.A))
#cat("Total(n=", s4_3aT, ")")
st(Ttmp3A, vars = c('Mod3completionT.A', title='Table 8g. SAS Total (After)', add.median = T))
```
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
ccc4_a3_summary %>%  gt() %>%  
...
#summary(as.numeric(tmp.3A$Mod3completionA))
#cat("Active(n=", s4_3aA, ")")
st(tmp.3A, vars = c('Mod3completionA', title='Table 9a. All SAS Active Participants', add.median = T))

#summary(as.numeric(ptmp3$Mod3completionP))
#cat("Passive(n=", s4_3aP, ")")
st(ptmp3, vars = c('Mod3completionP', title='Table 9b. SAS Passice Participants', add.median = T))
...
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
ccc4_all_3_summary %>%  gt() %>%  
  fmt_number(columns = "percentage.Active", decimals = 2) %>% 
  fmt_number(columns = "percentage.Passive", decimals = 2) %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
  tab_header(title = html("Table 9d. SAS Section Completion Time of All Verified Participants")) %>% 
  cols_label(time_frame = md("**Completion Time**"), freq.Active = md("**(N)**"), freq.Passive = md("**(N)**"), 
             freq = md("**(N)**"), 
             percentage.Active = md("**%**"), percentage.Passive = md("**%**"), percentage= md("**%**")) %>% 
  tab_footnote(
...
#cat("Active(n=", s4_4bA, ")")
#summary(as.numeric(tmp.4$Mod4completionA))
st(tmp.4, vars = c('Mod4completionA', title='Table 10a. LAW Active (Before)', add.median = T))

#cat("Passive(n=", s4_4bP, ")")
#summary(as.numeric(ptmp4$Mod4completionP))
st(ptmp4, vars = c('Mod4completionP', title='Table 10b. LAW Active (Before)', add.median = T))

#cat("Total(n=", s4_4bT, ")")
#summary(as.numeric(Ttmp.4$Mod4completionT.B))
st(Ttmp.4, vars = c('Mod4completionT.B', title='Table 10c. LAW Active (Before)', add.median = T))
```
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
...
#cat("Active(n=", s4_4aA, ")")
#summary(as.numeric(tmp.4$Mod4completionA))
st(tmp.4, vars = c('Mod4completionA', title='Table 10e. LAW Active (After)', add.median = T))

#cat("Passive(n=", s4_4aP, ")")
#summary(as.numeric(ptmp4$Mod4completionP))
st(ptmp4, vars = c('Mod4completionP', title='Table 10f. LAW Active (After)', add.median = T))

#cat("Total(n=", s4_4aT, ")")
#summary(as.numeric(Ttmp.4$Mod4completionT.A))
st(Ttmp.4, vars = c('Mod4completionT.A', title='Table 10g. LAW Active (After)', add.median = T))
```
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
ccc4_a4_summary %>%  gt() %>%  
...
#cat("Active(n=", s4_4aA, ")")
#summary(as.numeric(tmp.4$Mod4completionA))
st(tmp.4, vars = c('Mod4completionA', title='Table 11a. All LAW Active Participants', add.median = T))

#cat("Passive(n=", s4_4aP, ")")
#summary(as.numeric(ptmp4$Mod4completionP))
st(ptmp4, vars = c('Mod4completionP', title='Table 11b. All LAW Active Participants', add.median = T))

#cat("Total(n=", s4_4aT, ")")
#summary(as.numeric(Ttmp.4$Mod4completionT.A))
st(Ttmp.4, vars = c('Mod4completionT.A', title='Table 11c. All LAW Active Participants', add.median = T))
```
\FloatBarrier
```{r, echo=FALSE, warning = FALSE}
ccc4_all_4_summary %>%  gt() %>%  
  fmt_number(columns = "percentage.Active", decimals = 2) %>% 
  fmt_number(columns = "percentage.Passive", decimals = 2) %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
  tab_header(title = html("Table 11d. LAW Section Completion Time of All Verified Participants")) %>% 
  cols_label(time_frame = md("**Completion Time**"), freq.Active = md("**(N)**"), freq.Passive = md("**(N)**"), 
             freq = md("**(N)**"), 
             percentage.Active = md("**%**"), percentage.Passive = md("**%**"), percentage= md("**%**")) %>% 
  tab_footnote(
...
#site_ccc <- "SELECT d_789843387 FROM `nih-nci-dceg-connect-prod-6d04.Biospecimens.flatBoxes_WL`"

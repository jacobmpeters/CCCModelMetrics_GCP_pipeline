...
#Has a recruitment flag
merge_m3 <- merge_m3P %>% filter(D_512820379==486306141 | D_512820379==854703046)
...
funct_5 <- function(CID, CID_4, Title){  
  CID_SYM <- rlang::ensym(CID)
  CID_SYM_P4 <- rlang::ensym(CID_4)
  dt_select <- data_tib_all3 %>%  filter(!!CID_SYM_P4 != 804785430) %>% select(Connect_ID, !!CID_SYM)
  gt_yn <- dt_select  %>% group_by(!!CID_SYM) %>% summarize(n=n(), percentage=100*n/nrow(.)) %>% ungroup() %>% mutate(answer=recode(!!CID_SYM, !!!dict)) %>% 
    replace_na(list(answer="Skipped this Question")) %>%  select(answer, n, percentage)
...
funct_10_11 <- function(CID, CID_prev1, CID_prev9b, Title){
  CID_SYM <- rlang::ensym(CID)
  CID_SYM_P1 <- rlang::ensym(CID_prev1)
  CID_SYM_P9b <- rlang::ensym(CID_prev9b)
  dt_select <- data_tib_all3 %>%  filter((!!CID_SYM_P1 == 486319890) | (!!CID_SYM_P1 == 132232896) | (!!CID_SYM_P9b == 353358909)) %>%  select(Connect_ID, !!CID_SYM)
  gt_yn <- dt_select  %>% group_by(!!CID_SYM) %>% summarize(n=n(), percentage=100*n/nrow(.)) %>% ungroup() %>% mutate(answer=recode(!!CID_SYM, !!!dict)) %>%
    replace_na(list(answer="Skipped this Question")) %>%  select(answer, n, percentage)
...
# 
# dt_cig3 <- data_tib_all3_CIG[ , c("Connect_ID", "D_790436165_D_790436165_D_648960871")] 
# 
...
#CIG5
funct_5(D_798549704,D_639684251,"CIG5: Last Time Cigarettes Smoked")
...
funct_10_11(D_667002790, D_763164658, D_815776236, "CIG10: Timeframe for First Cigarette of the Day")



#CIG11

funct_10_11(D_534351312, D_763164658, D_815776236, "CIG11: Smoking before First Meal of the Day")
...
#CIGLIFEG
hist_funct(D_434034366, "CIGLIFEG: Cigarette Smoked per Day at Ages 60-69", "Cigarettes", "Frequency")

#CIGLIFEH
#hist_funct(D_842088582, "CIGLIFEH: Cigarette Smoked per Day at Ages 70+", "Cigarettes", "Frequency") #no one yet
#grid.arrange(cglifeA, cglifeB, nrow=2)
...
dtECIG_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#ECIG5
funct_5(D_238422161,D_751046675,"ECIG5: Last Time E-Cigs/Vaping Devises Used")
...
mhgroup9= data_tib_all3 %>%  filter(D_624111331==132232896 & !is.na(D_550244580_D_517801904) & (D_751046675==804785430 | D_242276545==353358909) & 
                                      as.numeric(data_tib_all3$D_550244580_D_517801904)<40  & !(as.numeric(data_tib_all3$D_360277949)<40)) %>% 
  mutate(surgery= case_when(D_442002787==428999623 ~ "15 minutes or less",
                                             ...
                                             TRUE ~ "Skipped this question"))
mhgroup9$surgery <- factor(mhgroup9$surgery,levels=c("15 minutes or less", "16 to 30 minutes", "31 to 59 minutes", "1 hour", "2 hours or more", "Skipped this question"))
...
dt_surgery_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#ECIGLIFEE
mhgroup9= data_tib_all3 %>%  filter(D_624111331==132232896 & !is.na(D_550244580_D_517801904) & (D_751046675==804785430 | D_242276545==353358909) & 
                                      as.numeric(data_tib_all3$D_550244580_D_517801904)<50   & !(as.numeric(data_tib_all3$D_360277949)<50)) %>% 
...
#ECIGLIFEF
mhgroup9= data_tib_all3 %>%  filter(D_624111331==132232896 & !is.na(D_550244580_D_517801904) & (D_751046675==804785430 | D_242276545==353358909) & 
                                      as.numeric(data_tib_all3$D_550244580_D_517801904)<60   & as.numeric(data_tib_all3$AGEGRID)>49) %>% #& !(as.numeric(data_tib_all3$D_360277949)<60)
...
#ECIGLIFEG
mhgroup9= data_tib_all3 %>%  filter(D_624111331==132232896 & !is.na(D_550244580_D_517801904) & (D_751046675==804785430 | D_242276545==353358909) & 
                                      as.numeric(data_tib_all3$D_550244580_D_517801904)<70  & as.numeric(data_tib_all3$AGEGRID)>59) %>% # & !(as.numeric(data_tib_all3$D_360277949)<70) 
...
data_tib_all3_CIGAR <- data_tib_all3 %>%  filter((data_tib_all3$D_182431332==486319890| data_tib_all3$D_182431332==132232896) & is.na(data_tib_all3$D_814115676_D_851145096))


CIGAR_ans= data_tib_all3_CIGAR %>%  mutate(answer= case_when(D_814115676_D_814115676_D_648960871==1 ~ "Never smoked on a regular basis",
                                             TRUE ~ "Skipped this question"))
...
dtCIGAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#CIGAR5
funct_5(D_789271762,D_564438246,"CIGAR5: Last Time Cigars Smoked")
...
cigar_kind= data_tib_all3_CIGAR %>%  filter(D_763164658==486319890 | D_763164658==132232896 | D_815776236==353358909) %>% mutate(kind= case_when(D_103566006_D_103566006_D_123926260 ==1 ~ "Cigar",
                                             D_103566006_D_103566006_D_741643840==1 ~ "Cigarello",
                                             D_103566006_D_103566006_D_959535900==1 ~ "Little Finger Cigar",
                                             D_103566006_D_103566006_D_807835037==1 ~ "Other",
                                             TRUE ~ "Skipped This Question"))
...
dtCIGAR10_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("CIGAR10: Kind of Cigar Smoked")) %>% 
  cols_label(n= md("**Number of Participants**"), kind = md("**Kind of Cigar**"), percentage = md("**Percentage of Participants**")) %>% 
  # summary_rows(
    # column = c(n,percentage),
    # fns= list(
    #   Sum= ~sum(.)
...
dtCHEW_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#CHEW5
funct_5(D_344631681,D_306320432,"CHEW5: Last Time Using Chewing Tobacco/Dip")
...
#CHEWLIFEA
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<17 & !(as.numeric(data_tib_all3$D_671380198)<17)) %>% 
  mutate(timespan= case_when(D_495592561==428999623 ~ "15 minutes or less",
                                             ...
                                             TRUE ~ "Skipped this question"))
lifetime$timespan <- factor(lifetime$timespan,levels=c("15 minutes or less", "16 to 30 minutes", "31 to 59 minutes", "1 hour", "2 hours or more", "Skipped this question"))
...
dt_timespan_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("CHEWLIFEA: Time Chewing Tobacco/Dip Used per Day at Ages 0-17")) %>% 
  cols_label(n= md("**Number of Participants**"),timespan = md("**Type**"), percentage = md("**Percentage of Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
#CHEWLIFEB
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<25 & !(as.numeric(data_tib_all3$D_671380198)<25)) %>% 
...
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<30 & !(as.numeric(data_tib_all3$D_671380198)<30)) %>% 
...
#CHEWLIFED
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<40 & !(as.numeric(data_tib_all3$D_671380198)<40)) %>% 
...
#CHEWLIFEE
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<50 & !(as.numeric(data_tib_all3$D_671380198)<50)) %>% 
...
#CHEWLIFEF
lifetime= data_tib_all3 %>%  filter(D_306320432==132232896 & !is.na(D_257300783_D_424527685) & (D_101710639==804785430 | D_785139115==353358909) & 
                                      as.numeric(data_tib_all3$D_257300783_D_424527685)<60 & !(as.numeric(data_tib_all3$D_671380198)<50) & as.numeric(data_tib_all3$AGEGRID)>49) %>% 
...
#CHEWLIFEG
#simple_funct3(D_995220236,"CHEWLIFEG: Time Chewing Tobacco/Dip Used per Day at Ages 60-69") #no one yet 
...
dtHOOKAH_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#HOOKAH5
funct_5(D_787047261,D_472007171,"HOOKAH5: Last Time Hookah Smoked")
...
dtPIPE_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#PIPE5
funct_5(D_845122623,D_458395129,"PIPE5: Last Time Tobacco Pipes Smoked")
...
#SECSMLF2E
simple_funct3(D_738219521_D_576358766, "SECSMLF2E: Frequency of Being Around Smokers from Age 40-49")



#SECSMLF2F
simple_funct3(D_738219521_D_767711152, "SECSMLF2F: Frequency of Being Around Smokers from Age 50-59")




#SECSMLF2G
simple_funct3(D_738219521_D_888898065, "SECSMLF2G: Frequency of Being Around Smokers from Age 60-69" )
...
dtSMMAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#SMMAR5
funct_5(D_180308733,D_503058092,"SMMAR5: Last Time Marijuana Smoked")
...
#SMMAR10  
funct_10_11(D_377064836_D_377064836, D_319397722, D_722122662, "SMMAR10: Why Do You Smoke Marijuana")
...
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<17  & !(as.numeric(data_tib_all3$D_863664828)<17)) %>% 
...
#SMMARLIFEB
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<24  & !(as.numeric(data_tib_all3$D_863664828)<24)) %>% 
...
#SMMARLIFEC
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<30  & !(as.numeric(data_tib_all3$D_863664828)<30)) %>% 
...
#SMMARLIFED
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<40  & !(as.numeric(data_tib_all3$D_863664828)<40)) %>% 
...
#SMMARLIFEE
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<50  & !(as.numeric(data_tib_all3$D_863664828)<50) & as.numeric(data_tib_all3$AGEGRID)>39) %>% 
...
#SMMARLIFEF
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<60  & !(as.numeric(data_tib_all3$D_863664828)<60) & as.numeric(data_tib_all3$AGEGRID)>49) %>% 
...
#SMMARLIFEG
lifetime= data_tib_all3 %>%  filter(D_319397722==132232896 & !is.na(D_116080663_D_889949861) & (D_503058092==804785430 | D_129677435==353358909) & 
                                      as.numeric(data_tib_all3$D_116080663_D_889949861)<70 & as.numeric(data_tib_all3$AGEGRID)>59 ) %>% #& !(as.numeric(data_tib_all3$D_863664828)<70) 
...
#TOMAR3
boxp_funct(D_378254382_D_628818510, "TOMAR3: Age Smoking Majiuana & Tobacco Combined Products on a Regular Basis", "Age")
...
dtTOMAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#TOMAR5
funct_5(D_444759994,D_891825638,"TOMAR5: Last Time Majiuana & Tobacco Combined Products Smoked")


#TOMAR6
tomr6=hist_funct(D_746817928, "TOMAR6: Majiuana & Tobacco Combined Products Smoked in the past 30 days", "Products", "Frequency")

#TOMAR7A
tomr7=hist_funct(D_992757226, "TOMAR7: Months Ago Majiuana & Tobacco Combined Products Last Smoked", "Months", "Frequency")
...
#TOMAR8D
hist_funct(D_363377579, "TOMAR8D: Days per Month Last Majiuana & Tobacco Combined Products Smoked", "Days", "Frequency")
...
#TOMAR9D
boxp_funct(D_606675249, "TOMAR9D: Age You Stopped Smoking Majiuana & Tobacco Combined Products Every Day", "Age")

#TOMAR9C
hist_funct(D_411960217, "TOMAR9C: Times per Day Majiuana & Tobacco Combined Products Smoked", "Times", "Frequency")




#TOMAR10  
funct_10_11(D_755923078_D_755923078, D_524914900, D_171050898, "SMMAR10: Why Do You Smoke Marijuana")
...
#TOMARLIFEB
tomrlfB=hist_funct(D_723763329, "TOMARLIFEB: Smoking Marijuana&Tobacco Combined Products: Ages 18-24", "Times per Day", "Frequency")


#TOMARLIFEC
tomrlfC=hist_funct(D_724990284, "TOMARLIFEC: Smoking Marijuana&Tobacco Combined Products: Ages 25-29", "Times per Day", "Frequency")
grid.arrange(tomrlfB, tomrlfC, nrow=2)


#TOMARLIFED
tomrlfD=hist_funct(D_383748300, "TOMARLIFED: Smoking Marijuana&Tobacco Combined Products: Ages 30-39", "Times per Day", "Frequency")


#TOMARLIFEE
tomrlfE=hist_funct(D_199612020, "TOMARLIFEE: Smoking Marijuana&Tobacco Combined Products: Ages 40-49", "Times per Day", "Frequency")
grid.arrange(tomrlfD, tomrlfE, nrow=2)


#TOMARLIFEF
#hist_funct(D_755298453, "TOMARLIFEF: Smoking Marijuana&Tobacco Combined Products: Ages 50-59", "Times per Day", "Frequency") #no one yet 


#TOMARLIFEG
#hist_funct(D_777877159, "TOMARLIFEG: Smoking Marijuana&Tobacco Combined Products: Ages 60-69", "Times per Day", "Frequency") #no one yet 


#TOMARLIFEH
#hist_funct(D_680697711, "TOMARLIFEH: Smoking Marijuana&Tobacco Combined Products: Ages 70+", "Times per Day", "Frequency")#no one yet 
...
dtELMAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#ELMAR5
funct_5(D_859228803,D_521073718,"ELMAR5: Last Time Marijuana Vaped")
...
#ELMAR10
funct_10_11(D_268240612_D_268240612, D_325229459, D_177252178, "SMMAR10: Why Do You Smoke Marijuana")
...
#ELMARLIFED
lifetime= data_tib_all3 %>%  filter(D_325229459==132232896 & !is.na(D_942945860_D_742716427) & (D_521073718==804785430 | D_142164107==353358909) & 
                                      as.numeric(data_tib_all3$D_942945860_D_742716427)<40  & !(as.numeric(data_tib_all3$D_445187084)<40)) %>% 
...
#ELMARLIFE
lifetime= data_tib_all3 %>%  filter(D_325229459==132232896 & !is.na(D_942945860_D_742716427) & (D_521073718==804785430 | D_142164107==353358909) & 
                                      as.numeric(data_tib_all3$D_942945860_D_742716427)<50  & !(as.numeric(data_tib_all3$D_445187084)<50) & as.numeric(data_tib_all3$AGEGRID)>39) %>% 
...
lifetime= data_tib_all3 %>%  filter(D_325229459==132232896 & !is.na(D_942945860_D_742716427) & (D_521073718==804785430 | D_142164107==353358909) & 
                                      as.numeric(data_tib_all3$D_942945860_D_742716427)<60  & !(as.numeric(data_tib_all3$D_445187084)<60) & as.numeric(data_tib_all3$AGEGRID)>49) %>% 
...
#ELMARLIFEG--no one yet
lifetime= data_tib_all3 %>%  filter(D_325229459==132232896 & !is.na(D_942945860_D_742716427) & (D_521073718==804785430 | D_142164107==353358909) & 
                                      as.numeric(data_tib_all3$D_942945860_D_742716427)<70  & !(as.numeric(data_tib_all3$D_445187084)<70) & as.numeric(data_tib_all3$AGEGRID)>59) %>% 
...
dtEAMAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#EAMAR5
funct_5(D_921663542,D_742544044,"EAMAR5: Last Time Marijuana Consumed in Food/Drinks")


#EAMAR6
eam6=hist_funct(D_818380721, "EAMAR6: Total Days Consuming Marijuana in Food/Drinks in the past 30 days", "Days", "Frequency")
...
dtEAMAR9A_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#EAMAR10 
funct_10_11(D_810324917_D_810324917, D_101170268, D_891996278, "EAMAR10: Why Do You Consume Marijuana in Food/Drinks")
...
dtTHMAR_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#THMAR5
funct_5(D_532755074,D_420155119,"THMAR5: Last Time THC Dabbing Used")
...
dtTHMAR9A_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
funct_10_11(D_265469878_D_265469878, D_355689185, D_937550939, "THMAR10: Why Do You Use THC Concentrates via Dabbing")
...
#THMARLIFEB
thmlfB=hist_funct(D_375227733, "THMARLIFEB: Servings per Day of THC Concetrates via Dabbing: Ages 18-24", "Servings", "Frequency")

#THMARLIFEC
thmlfC=hist_funct(D_752795304, "THMARLIFEC: Servings per Day of THC Concetrates via Dabbing: Ages 25-29", "Servings", "Frequency")
grid.arrange(thmlfB, thmlfC, nrow=2)

#THMARLIFED
thmlfD=hist_funct(D_417552256, "THMARLIFED: Servings per Day of THC Concetrates via Dabbing: Ages 30-39", "Servings", "Frequency")

#THMARLIFEE
thmlfE=hist_funct(D_963040791, "THMARLIFEE: Servings per Day of THC Concetrates via Dabbing: Ages 40-49", "Servings", "Frequency")
grid.arrange(thmlfD, thmlfE, nrow=2)

#THMARLIFEF
thmlfF=hist_funct(D_685659661, "THMARLIFEF: Servings per Day of THC Concetrates via Dabbing: Ages 50-59", "Servings", "Frequency")

#THMARLIFEG
thmlfG=hist_funct(D_511145980, "THMARLIFEG: Servings per Day of THC Concetrates via Dabbing: Ages 60-69", "Servings", "Frequency")
grid.arrange(thmlfF, thmlfG, nrow=2)

#THMARLIFEH
#hist_funct(D_227784207, "THMARLIFEH: Servings per Day of THC Concetrates via Dabbing: Ages 70+", "Servings", "Frequency")
...
boxp_funct(D_556837046_D_141874857, "ALCOHOL4_AGE: Age Drinking Alcohol on a Regular Basis", "Age")
  #Alcohol4_never
data_tib_all3_ALC4 <- data_tib_all3 %>%  filter(data_tib_all3$D_429228540==486319890| data_tib_all3$D_429228540==132232896)
...
dtALC4_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dtALC7= data_tib_all3 %>% filter(D_338467033==104430631 | is.na(D_338467033))
...
alc_stop= dtALC7 %>%  mutate(answers= case_when(D_789159346_D_789159346_D_895826652 ==1 ~ "Personal Choice",
                                             ...
                                             D_789159346_D_789159346_D_807835037==1 ~ "Other",
                                             TRUE ~ "Skipped this question"))
...
dtALC7_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("ALCOHOL7: Reason You stopped Drinking")) %>% 
  cols_label(n= md("**Number of Participants**"), answers = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
  # summary_rows(
...
edu$edlevel <- factor(edu$edlevel,levels=c("Never", "1 to 5 times per year", "6 to 11 times per year","Once per month","2 to 3 times per month","Once per week","Twice per week","3 to 4 times per week", "5 to 6 times per week", "Every Day","Skipped This Question"))
...
#ALCLIFE4A 
dt_alcl <- module3 %>% filter(module3$D_429228540==132232896 & !is.na(module3$D_556837046_D_141874857) & 
                                       (module3$D_338467033==353358909 | (module3$D_338467033==104430631 & !is.na(module3$D_480426504))) & 
                                       ((is.na(module3$D_480426504) & as.numeric(module3$D_556837046_D_141874857)<17) | 
                                          (!is.na(module3$D_480426504) & as.numeric(module3$D_556837046_D_141874857)<17 &       
                                             as.numeric(module3$D_480426504)>17)))



alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_912659087_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_643512687_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_688123102_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_356133766_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_690918725_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_178609656_D_789689151=="1"~"Drank Beer",
...
alcl4= dt_alcl  %>%  mutate(oth_age= case_when(D_470862706_D_261957180_D_789689151=="1"~"Drank Beer",
...
dttanbed3_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dttanbed5_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 

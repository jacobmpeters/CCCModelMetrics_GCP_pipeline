...
#Only these variables carry over from mod1 into mod3:
  #age, agecor
#Going to see if only these are selected, if it will allow the automation to run
sql_M1_1 <- bq_project_query(project, query="SELECT Connect_ID, D_479353866, D_150344905 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.module1_v1_JP` where Connect_ID is not null")
sql_M1_2 <- bq_project_query(project, query="SELECT Connect_ID, D_479353866, D_150344905 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.module1_v2_JP` where Connect_ID is not null")
...
where Connect_ID IS NOT NULL and (d_512820379='486306141' OR d_512820379='854703046') and (D_919254129='353358909') and (D_699625233='353358909') and (d_949302066='231311385') and d_976570371='231311385'"
...
module3 <- merge_m3 %>% filter(D_699625233==353358909)



cat("Particiapnts with Module 3 Completion: ", dim(module3)[[1]])

...
```
```{r LanguageTable, warning=FALSE, echo=FALSE, message=FALSE}
...
# 
# 
# dtdiebts_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# 
# 
# dtbreast_d4_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# 
# 
# dtdprss_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt___mom_cnc_summary <- dt_mom_cnc_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
# 
# 
# dtalt_add1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 

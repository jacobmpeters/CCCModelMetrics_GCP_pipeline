...
dt_all_races_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"), race = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
    grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_am_ind_ethn_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  ...
  cols_label(n= md("**N**"), ethnicity = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>%
    grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_appearence_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  ...
  cols_label(n= md("**N**"),descr = md("**Description**"), percentage = md("**Percentage of Participants**")) %>%
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_sex2_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"), body_part = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
    grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_skincnc_type_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"),Type = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_fam_canc_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"), status = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
dt_mom_cnc_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"), cancer = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_agep_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**N**"), horm = md("**Answer**"), percentage = md("**Percentage of Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
merge_m4P= left_join(mod4_data, merged, by="Connect_ID") 

...
sexorient_raceage_table_gt <- sexorient_raceage_table %>%  gt::gt(rowname_col = "row_lab") %>%  
  cols_label(n= md("**Number of Participants**"), age="Age", race="Race", percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) 
...
sexorient_age_race_gt <-  sexorient_table1 %>%  gt::gt(rowname_col = "row_lab") %>%  
  cols_label(n= md("**Number of Participants**"), age="Age", race="Race", sexuality="'Other Sexuality' Response", percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) 
...
sexorient_age_gt <- sexorient_table2 %>%  gt::gt(rowname_col = "row_lab") %>%  
  cols_label(n= md("**Number of Participants**"), age="Age", sexuality="'Other Sexuality' Response", percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) 
...
sexorient_table %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>%
  cols_label(n= md("**Number of Participants**"), sexuality=md("**'Other Sexuality' Response**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) 
...
dt_wt1825_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"), weight = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
dt_altcont1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"),Contact = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_pain7_1 <- pain7_1 %>%  gt::gt() %>%  
  ...
  cols_label(Frequency= md("**Number of Participants**"), Condition = md("**Answer**"), Percentage = md("**Percentage of <br> Participants**")) %>% 
  tab_options(
      stub.font.weight = "bold"
    ) %>%
  tab_style(
...
acid_sup_summary %>%  gt::gt() %>%  
  ...
  cols_label(n= md("**Number of Participants**"), med = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_regt_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"), howlong = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
dt_mens_lgth_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"), length = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
dtHORMED_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  ...
  cols_label(n= md("**Number of Participants**"), meds = md("**Medications**"), percentage = md("**Percentage of <br> Participants**")) %>%
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
dtPROGHOR_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"), meds = md("**Hormones**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
    stub.font.weight = "bold"
  ) %>%
...
simple_funct2(D_733547268_D_151161693, "HOUSE1E: Frequency of Walking while Shopping")
 ...
 dt_house2a_summary %>%  gt::gt(rowname_col = "row_lab") %>% 
   ...
   cols_label(n= md("**Number of Participants**"), time = md("**Time Spent**"), percentage = md("**Percentage of <br> Participants**")) %>% 
   grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|> 
   tab_options( 
       stub.font.weight = "bold" 
     ) %>% 
...
#warning=FALSE, echo=FALSE, message=FALSE
 ...
 dtLAWN1_summary %>%  gt::gt(rowname_col = "row_lab") %>% 
   ...
   cols_label(n= md("**Number of Participants**"), chore = md("**Chores**"), percentage = md("**Percentage of <br> Participants**")) %>% 
   grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|> 
   tab_options( 
       stub.font.weight = "bold" 
     ) %>% 
 ...
 dtLAWN2A_summary %>%  gt::gt(rowname_col = "row_lab") %>%   
   ...
   cols_label(n= md("**Number of Participants**"), season = md("**Answer**"), percentage = md("**Percentage of <br> Participants**")) %>%  
   grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|> 
   tab_options( 
       stub.font.weight = "bold" 
     ) %>% 
...
dtSLPROB2_flexible %>%  gt::gt(rowname_col = "row_lab") %>%  
  ...
  cols_label(n= md("**Number of Participants**"), flex = md("**Flexibility**"), percentage = md("**Percentage of <br> Participants**")) %>% 
  grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dict <- list("104430631"="No", "353358909"="Yes", "265550580"="Didn't Drink ", "950039557"="A few times per Year","402048066"="A few times per Month","522395860"="Once per Week",
             ...
             "777809207"="Dark Brown", "181769837"="Other", "230748315"="Blond",  "379848047"="#3C989E", "224120697"="Reddish Brown", "270559240"="Medium Brown",  "469115418"="Black", "300633065"="Very Light",

...
one_logic_funct1(D_952682839, D_323512813, "353358909", "PAIN2: Rank of Pain")
...
#Second pregnancy
data_tib_all2$D_391951010_2_2 <- factor(data_tib_all2$D_391951010_2_2, levels=c(582602017, 105727261, 720288326, "Skipped this Question"))
two_skip_funct2(D_391951010_2_2, "PREG6_2: Infants delivered during second pregnancy", D_391951010_1_1, "628445697", "419220239")


#Third Pregnancy
data_tib_all2$D_391951010_3_3 <- factor(data_tib_all2$D_391951010_3_3, levels=c(582602017, 105727261, 720288326, "Skipped this Question"))
two_skip_funct2(D_391951010_3_3, "PREG6_3: Infants delivered during third pregnancy", D_391951010_1_1, "628445697", "419220239")

#Fourth Pregnancy
data_tib_all2$D_391951010_4_4 <- factor(data_tib_all2$D_391951010_4_4, levels=c(582602017, 105727261, 720288326, "Skipped this Question"))

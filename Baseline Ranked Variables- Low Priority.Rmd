...
recr_m1 <- bq_table_download(recr_M1,bigint = "integer64",n_max = Inf, page_size = 1000)
...
recr_m2 <- bq_table_download(recr_m2,bigint = "integer64",n_max = Inf, page_size = 1000)
...
M2_V1 <- bq_table_download(sql_m2_1,bigint = "integer64",n_max = Inf) #1436 #1436 vars: 1507 01112023 
M2_V2 <- bq_table_download(sql_m2_2,bigint = "integer64",n_max = Inf) #2333 #3033 01112023 var:1531 #6339 obs 1893 vars 05022023
...
#warning=FALSE, echo=FALSE, message=FALSE
 ...
 ##simple_funct1(D_649352910_D_654385712, "SITTINGA: Driving or Sitting in a Car, Bus, or Train") 
 ...
 ##simple_funct1(D_649352910_D_263483736, "SittingB: Watching TV or other Video Content") 
 ...
 ##simple_funct1(D_649352910_D_806746224, "SittingC: Browsing or Playing Games") 
 ...
 ##simple_funct1(D_649352910_D_396649512, "SittingD: Other Activity") 
...
#warning=FALSE, echo=FALSE, message=FALSE
 ...
 ##simple_funct1(D_733547268_D_980120253, "HOUSE1A: Frequency of Light Household Chores") 
 ...
 ##simple_funct1(D_733547268_D_993029890, "HOUSE1B: Frequency of Moderate to Vigorous Household Chores") 
 ...
 ##simple_funct1(D_733547268_D_980196073, "HOUSE1C: Frequency of Caring for Pets") 
 ...
 ##simple_funct1(D_733547268_D_115422925, "HOUSE1D: Frequency of Caring for Kids/Adults") 
 ...
 ##simple_funct1(D_733547268_D_151161693, "HOUSE1E: Frequency of Walking while Shopping") 
...
# SLHABIT1A-G
```{r, warning=FALSE, echo=FALSE, message=FALSE}
##simple_funct1(D_421859821_D_220238240, "SLHABIT1A: Having Trouble Falling Asleep")
...
##simple_funct1(D_421859821_D_151006826, "SLHABIT1B: Waking up Several Times per Night")
SLHABIT1B_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_151006826==104430631 ~ "No",
                                                     D_421859821_D_151006826==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_151006826==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_151006826==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_151006826==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
#Wake up early
##simple_funct1(D_421859821_D_965290070, "SLHABIT1C: Waking up Too early")
SLHABIT1C_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_965290070==104430631 ~ "No",
                                                     D_421859821_D_965290070==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_965290070==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_965290070==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_965290070==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
##simple_funct1(D_421859821_D_781115321, "SLHABIT1D: Trouble Falling Back Asleep")
SLHABIT1D_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_781115321==104430631 ~ "No",
                                                     D_421859821_D_781115321==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_781115321==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_781115321==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_781115321==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
#sleeping pills
##simple_funct1(D_421859821_D_453071098, "SLHABIT1E: Prescription Sleep Medication Taken")
SLHABIT1E_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_453071098==104430631 ~ "No",
                                                     D_421859821_D_453071098==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_453071098==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_453071098==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_453071098==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
#Irritable
##simple_funct1(D_421859821_D_513065503, "SLHABIT1F: Sleep Problems causing Irritability")
SLHABIT1F_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_513065503==104430631 ~ "No",
                                                     D_421859821_D_513065503==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_513065503==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_513065503==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_513065503==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
##simple_funct1(D_421859821_D_257137378, "SLHABIT1G: Feeling Tired Throughout the day")
SLHABIT1G_ans= data_tib_all2 %>%  mutate(answer= case_when(D_421859821_D_257137378==104430631 ~ "No",
                                                     D_421859821_D_257137378==525779785 ~ "Yes, less than once per week",
                                                     D_421859821_D_257137378==565036180 ~ "Yes, 1 or 2 times per week",
                                                     D_421859821_D_257137378==284343405 ~ "Yes, 3 or 4 times per week",
                                                     D_421859821_D_257137378==270994579 ~ "Yes, 5 or more times per week",
                                                        TRUE ~ "Skipped this question"))
...
#Sleep last 4 weeks
##simple_funct1(D_910856756, "SLHABIT2: Sleep Quality in the Last Four Weeks")
...
#sitting and reading
##simple_funct1(D_981441822_D_403155173, "SLHABIT3A: Chance of Falling Asleep while Sitting and Reading")
...
#watch tv
##simple_funct1(D_981441822_D_576621769, "SLHABIT3B: Chance of Falling Asleep while Watching TV")
...
#sitting inactive
##simple_funct1(D_981441822_D_988508028, "SLHABIT3C: Chance of Falling Asleep while Sitting Inactive")
...
#riding passenger
##simple_funct1(D_981441822_D_186488870, "SLHABIT3D: Chance of Falling Asleep while Sitting as a Passenger in the Car")
...
##simple_funct1(D_981441822_D_922388461, "SLHABIT3E: Chance of Falling Asleep while Lying Resting in the Afternoon")
...
#sitting talking
##simple_funct1(D_981441822_D_760686611, "SLHABIT3F: Chance of Falling Asleep while Sitting and Talking")
...
##simple_funct1(D_981441822_D_354550061, "SLHABIT3G: Chance of Falling Asleep while Sitting after Lunch w/o Alcohol")
...
#traffic light
##simple_funct1(D_981441822_D_179705366, "SLHABIT3H: Chance of Falling Asleep while Stopped at a Traffic Light")
...
#dinner table
##simple_funct1(D_981441822_D_955609858, "SLHABIT3I: Chance of Falling Asleep while at the Dinner Table")
...
parts3_data <- bq_table_download(parts3_table, bigint = "integer64",n_max = Inf, page_size = 1000)
mod3_data <- bq_table_download(mod3_table, bigint = "integer64",n_max = Inf)
...
dict <- list("104430631"="No", "353358909"="Yes", "265550580"="Didn't Drink ", "950039557"="A few times per Year","402048066"="A few times per Month","522395860"="Once per Week",
             ...
             "585672584"="Both", "807835037"="Other", "746038746"="Prefer Not to Answer")
...
parts_data <- bq_table_download(parts_table, bigint = "integer64",n_max = Inf, page_size = 1000)
mod4_data <- bq_table_download(mod4_table, bigint = "integer64",n_max = Inf)

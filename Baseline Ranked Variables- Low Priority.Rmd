...
# orient= data_tib_base  %>%  mutate(sexuality= case_when(tolower(D_555481393_D_979809707)=="asexual" | tolower(D_555481393_D_979809707)=="a sexual" ~ "Asexual",
...
data_tib_base %>%  select(D_555481393_D_979809707) %>% filter(!is.na(D_555481393_D_979809707)) %>% gt() %>% cols_label(D_555481393_D_979809707= md("**Response for 'Other' Sexual Orientation**"))
...
#Scale
dt_painsc= data_tib_base   %>%  filter(D_323512813==353358909)
...
#Affected Work?
dt_painaff= data_tib_base   %>%  filter(D_323512813==353358909)
...
dt_fem_hair= data_tib_base   %>% filter(D_407056417==536341288) 
...
dt_male_hair= data_tib_base   %>% filter(D_407056417==654207589) 
...
ACNEMED= data_tib_base %>% filter(D_283634623==353358909)
...
SIB2_1= data_tib_base %>% filter(as.numeric(D_694265648 ) >=1)
...
dtSIB3_1= data_tib_base  %>%   filter(D_694265648!=0 & !is.na(D_694265648))
...
SIB4_1= data_tib_base %>% filter(as.numeric(D_694265648 ) >=1)
...
CHILD2_1= data_tib_base %>% filter(as.numeric(D_446999144 ) >=1)
...
dtCHILD3_1= data_tib_base  %>%   filter(as.numeric(D_446999144) >=1)
...
CHILDMULT_1= data_tib_base %>% filter(as.numeric(D_446999144 ) >=1)
...
CHILD4_1= data_tib_base %>% filter(as.numeric(D_446999144 ) >=1)
...
WORK4= data_tib_base %>%  filter(data_tib_base$D_613744428==353358909) %>% mutate(answer= case_when(as.numeric(D_739294356)==0 ~ "0",
...
merge_m2= left_join(M2_complete_nodup,merged,  by="Connect_ID") #%>%  left_join(m3_data, by="Connect_ID")
...
data_all3= left_join(merged, mod3_data, by="Connect_ID")

...
dict <- list("353358909"="Yes", "104430631"="No",  "178420302"="Do not Know", 
             ...
             "113771607" = "Surgery to Remove One Kidney",
             "668256654" = "Surgery to Remove Both Kidneys", 
...
#neph_type <- one_logic_funct(D_951847507, D_729984625_D_215525943, 1, "Type of Kidney Removal Surgery")
cat(round((sum(screen$D_951847507==113771607, na.rm=T)/sum(screen$D_729984625_D_215525943==1, na.rm=T))*100, digits=2), "% Had Surgery to Remove One Kidney")
cat(round((sum(screen$D_951847507==668256654, na.rm=T)/sum(screen$D_729984625_D_215525943==1, na.rm=T))*100, digits=2), "% Had Surgery to Remove Both Kidneys")
cat(round((sum(screen$D_951847507==535003378, na.rm=T)/sum(screen$D_729984625_D_215525943==1, na.rm=T))*100, digits=2), "% Had Neither of These Nephrectomy Types")
...
#one_logic_funct(D_765772509, D_506456253_D_802859122, 1, "Type of Breast Removal Surgery")
cat(round((sum(screen$D_765772509==308633554, na.rm=T)/sum(screen$D_506456253_D_802859122==1, na.rm=T))*100, digits=2), "% Had Both Breasts Removed During One Surgery")
cat(round((sum(screen$D_765772509==967156738, na.rm=T)/sum(screen$D_506456253_D_802859122==1, na.rm=T))*100, digits=2), "% Had Both Breasta Removed, Each During a Separate Surgery")
cat(round((sum(screen$D_765772509==535003378, na.rm=T)/sum(screen$D_506456253_D_802859122==1, na.rm=T))*100, digits=2), "% Had Neither of These Mastectomy Types")
...
#cat("Oophorectomy")
  #type
cat(round((sum(screen$D_590067228==333647143, na.rm=T)/sum(screen$D_729984625_D_630100221==1, na.rm=T))*100, digits=2), "% Had One Ovary Removed")
cat(round((sum(screen$D_590067228==109972911, na.rm=T)/sum(screen$D_729984625_D_630100221==1, na.rm=T))*100, digits=2), "% Had Both Ovaries Removed")
cat(round((sum(screen$D_590067228==535003378, na.rm=T)/sum(screen$D_729984625_D_630100221==1, na.rm=T))*100, digits=2), "% Had Neither of These Oophorectomy Types")
  #age/year of surgery
...
#cat("Salpingectomy") 
  #type
cat(round((sum(screen$D_860839849==448068764, na.rm=T)/sum(screen$D_729984625_D_692881833==1, na.rm=T))*100, digits=2), "% Had One Fallopian Tube Removed")
cat(round((sum(screen$D_860839849==537173119, na.rm=T)/sum(screen$D_729984625_D_692881833==1, na.rm=T))*100, digits=2), "% Had Both Fallopian Tubes Removed")
cat(round((sum(screen$D_860839849==535003378, na.rm=T)/sum(screen$D_729984625_D_692881833==1, na.rm=T))*100, digits=2), "% Had Neither of These Salpingectomy Types")
  #age/year
...
#cat("Orchiectomy or Ochidectomy") 
  #type
cat(round((sum(screen$D_429157727==770550588, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had One Testicle Removed")
cat(round((sum(screen$D_429157727==970716952, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had Both Testicles Removed")
cat(round((sum(screen$D_9429157727==535003378, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had Neither of These Orchiectomy or Ochidectomy Types")
  #age/year
...
#cat("Prostatectomy") 
  #type
cat(round((sum(screen$D_292314539==524029283, na.rm=T)/sum(screen$D_729984625_D_733236542==1, na.rm=T))*100, digits=2), "% Had Part of Prostate Removed")
cat(round((sum(screen$D_292314539==500023550, na.rm=T)/sum(screen$D_729984625_D_733236542==1, na.rm=T))*100, digits=2), "% Had Whole Prostate Removed")
cat(round((sum(screen$D_292314539==535003378, na.rm=T)/sum(screen$D_729984625_D_733236542==1, na.rm=T))*100, digits=2), "% Had Neither of These Prostatectomy Types")
  #age/year
...
cat(round((sum(screen$D_429157727==770550588, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had One Testicle Removed")
cat(round((sum(screen$D_429157727==970716952, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had Both Testicles Removed")
cat(round((sum(screen$D_429157727==535003378, na.rm=T)/sum(screen$D_729984625_D_532603425==1, na.rm=T))*100, digits=2), "% Had Neither of These Orchiectomy or Ochidectomy Types")
  #age/year
orch_a_sg=boxp_funct(D_314345103_D_623218391,"Age at Orchiectomy Surgery","Age") 
orch_y_sg=boxp_funct(D_314345103_D_802622485,"Year of Orchiectomy Surgery","Year")
grid.arrange(orch_a_sg, orch_y_sg, nrow=2)

...
table(letter_cont2$letter) #even enough
...
kable(OR_additive[, c(1,4)], caption="Age+Race+Sex+Site+Letter Logitsic", format = "latex", booktabs = TRUE) %>%  
...
kable(OR_additive2[, c(1,4)], caption="Age+Race+Sex+Site+Letter Firth's Correction", format = "latex", booktabs = TRUE) %>%  
  kable_styling(latex_options = "hold_position")
...
kable(OR_inter[, c(1,4)], caption="age*letter + race*letter + sex*letter + site*letter Logitsic", format = "latex", booktabs = TRUE) %>%  
  kable_styling(latex_options = "hold_position")
...
OR_inter2 <- OR_inter2 %>% mutate(CI= paste0("(", OR_inter2$`2.5 %`, ",", OR_inter2$`97.5 %`, ")"))
kable(OR_inter2[, c(1,4)], caption="age*letter + race*letter + sex*letter + site*letter Firth's Correction", format = "latex", booktabs = TRUE) %>%  
  kable_styling(latex_options = "hold_position")

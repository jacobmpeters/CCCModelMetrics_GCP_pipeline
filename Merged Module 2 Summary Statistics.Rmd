...
```{r M2functions, warning=FALSE, include=FALSE}
...
#one_logic_funct2(D_976052812, D_112024853, 353358909, "METFOR5: Last Time Metformin Taken")
...
FERT1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
FERT3_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
FERT5_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
FERT8_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_2_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_3_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_4_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_5_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_6_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_7_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_8_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
HORMED3_9_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
MENOHOR_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
ESTROHOR3_1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
ESTROHOR3_2_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
ESTROHOR3_3_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
ESTROHOR3_4_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
ESTROHOR3_5_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
PROGHOR3_1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
PROGHOR3_2_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
COMBHOR3_1_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
COMBHOR3_2_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
testt1= data_tib_m2 %>% filter(D_570187182==353358909) %>%  mutate(answer= case_when(D_466727144==104430631 ~ "No",
                                                                                     D_466727144==353358909 ~ "Yes",
                                                                                     TRUE ~ "Skipped this question"))
...
dtEXEREC3A_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4A_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3B_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4B_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4C_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3D_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4D_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3E_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4E_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3F_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4F_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3G_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4G_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3H_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4H_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3I_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4I_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3J_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4J_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3K_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4K_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3L_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4L_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3M_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4M_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3N_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4N_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC3O_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
dtEXEREC4O_summary %>%  gt::gt(rowname_col = "row_lab") %>%
  fmt_number(columns = "percentage", decimals = 2) %>%
...
```{r Lanw2, warning=FALSE, echo=FALSE,  message=FALSE}
#How often- moderate
...
vig_ss= LAWN4A %>%  mutate(season= case_when(D_429531329==428999623 ~ "0-15 minutes",
                                             ...
                                             D_429531329==638092100 ~ "45-59 minutes",
...
vig_ss= LAWN4B %>%  mutate(season= case_when(D_644018981==428999623 ~ "0-15 minutes",
                                             ...
                                             D_644018981==638092100 ~ "45-59 minutes",
...
vig_ss= LAWN4C %>%  mutate(season= case_when(D_267261558==428999623 ~ "0-15 minutes",
                                             ...
                                             D_267261558==638092100 ~ "45-59 minutes",
...
SLHABIT1B_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_151006826==104430631 ~ "No",
...
SLHABIT1C_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_965290070==104430631 ~ "No",
...
SLHABIT1D_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_781115321==104430631 ~ "No",
...
SLHABIT1E_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_453071098==104430631 ~ "No",
...
SLHABIT1F_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_513065503==104430631 ~ "No",
...
SLHABIT1G_ans= data_tib_m2 %>%  mutate(answer= case_when(D_421859821_D_257137378==104430631 ~ "No",
...
SNORING5_ans$answer <- factor(SNORING5_ans$answer,levels=c("Almost every day", "3 to 4 times per week", "1 to 2 times per week", 
                                                           "1 to 2 times per month", "Less than 1 to 2 times per month", "Never", 
                                                           "Unknown", "Skipped this question" ))

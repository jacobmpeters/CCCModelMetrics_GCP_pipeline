...
Original Missingness Analysis of Module 4-- Reviewing the skipping of questions by participants 
Using the skip logic from Qx:https://nih.app.box.com/file/923661036132?s=o816d6804w154fqf5y161ii7ngvcezqg
...
dt_home1skip_summary[2,1] <- "Skipped Street Name" 
...
Followup1_skip= Mod4 %>%  filter(Mod4$D_920576363_D_920576363!="[178420302]") %>% 
  mutate(Address= case_when(is.na(D_920576363_D_725583683) & is.na(D_121490150_D_303500597)~"Skipped City Follow-up"))
...
Followup1__skip[2,2] <- sum(is.na(Followup1_skip$D_920576363_D_917021073) & is.na(Followup1_skip$D_121490150_D_195068098))
Followup1__skip[2,3] <- (sum(is.na(Followup1_skip$D_920576363_D_917021073) & is.na(Followup1_skip$D_121490150_D_195068098))/dim(Followup1_skip)[[1]])*100

Followup1__skip[3,1] <- "Skipped ZIP Follow-up"
Followup1__skip[3,2] <- sum(is.na(Followup1_skip$D_920576363_D_970000442) & is.na(Followup1_skip$D_121490150_D_202784871))
Followup1__skip[3,3] <- (sum(is.na(Followup1_skip$D_920576363_D_970000442) & is.na(Followup1_skip$D_121490150_D_202784871))/dim(Followup1_skip)[[1]])*100
...
Followup1__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Address 1 Follow-up Skipped")) %>% 
  cols_label(n= md("**Number of Participants**"),Address = md("**Question**"), percentage = md("**Percentage of Participants**")) %>% 
  #grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
home_add3_1= Mod4 %>% #select(D_804504024_D_105043152, D_804504024_D_543135391) %>% 
  filter(Mod4$D_804504024_D_804504024!="[178420302]" & 
...
dt_home_add3_1 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addoth %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addsum1 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home2skip= home2 %>%  mutate(Address1= case_when(is.na(Street_Number)~"Skipped Street Number"))
...
dt_home2skip_summary[2,1] <- "Skipped Street Name" 
dt_home2skip_summary[2,2] <- sum(is.na(home2skip$Street_Name))
dt_home2skip_summary[2,3] <- (sum(is.na(home2skip$Street_Name))/dim(home2skip)[[1]])*100

dt_home2skip_summary[3,1] <- "Skipped City"
dt_home2skip_summary[3,2] <- sum(is.na(home2skip$City))
dt_home2skip_summary[3,3] <- (sum(is.na(home2skip$City))/dim(home2skip)[[1]])*100

dt_home2skip_summary[4,1] <- "Skipped State"
dt_home2skip_summary[4,2] <- sum(is.na(home2skip$State))
dt_home2skip_summary[4,3] <- (sum(is.na(home2skip$State))/dim(home2skip)[[1]])*100

dt_home2skip_summary[5,1] <- "Skipped ZIP"
dt_home2skip_summary[5,2] <- sum(is.na(home2skip$ZIP))
dt_home2skip_summary[5,3] <- (sum(is.na(home2skip$ZIP))/dim(home2skip)[[1]])*100

dt_home2skip_summary[6,1] <- "Skipped Country"
dt_home2skip_summary[6,2] <- sum(is.na(home2skip$Country))
dt_home2skip_summary[6,3] <- (sum(is.na(home2skip$Country))/dim(home2skip)[[1]])*100

dt_home2skip_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
Followup2_skip= home2 %>%  filter(home2$D_444145120_D_444145120!="[178420302]") %>% 
  mutate(Address= case_when(is.na(D_444145120_D_288498031) & is.na(D_574985342_D_536516743)~"Skipped City Follow-up"))
...
Followup2__skip[2,1] <- "Skipped State Follow-up" 
Followup2__skip[2,2] <- sum(is.na(Followup2_skip$D_444145120_D_195845897) & is.na(Followup2_skip$D_574985342_D_283900560))
Followup2__skip[2,3] <- (sum(is.na(Followup2_skip$D_444145120_D_195845897) & is.na(Followup2_skip$D_574985342_D_283900560))/dim(Followup2_skip)[[1]])*100

Followup2__skip[3,1] <- "Skipped ZIP Follow-up"
Followup2__skip[3,2] <- sum(is.na(Followup2_skip$D_444145120_D_936129960) & is.na(Followup2_skip$D_574985342_D_467947502))
Followup2__skip[3,3] <- (sum(is.na(Followup2_skip$D_444145120_D_936129960) & is.na(Followup2_skip$D_574985342_D_467947502))/dim(Followup2_skip)[[1]])*100

Followup2__skip[4,1] <- "Skipped Country Follow-up"
Followup2__skip[4,2] <- sum(is.na(Followup2_skip$D_444145120_D_924583345) & is.na(Followup2_skip$D_574985342_D_368486703))
Followup2__skip[4,3] <- (sum(is.na(Followup2_skip$D_444145120_D_924583345) & is.na(Followup2_skip$D_574985342_D_368486703))/dim(Followup2_skip)[[1]])*100


Followup2__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home_add3_2= home2 %>% #select(D_804504024_D_105043152, D_804504024_D_543135391) %>% 
  filter(home2$D_398762737_D_398762737!="[178420302]" & 
...
dt_home_add3_2 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addoth2 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addsum2 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home3skip= home3 %>%  mutate(Address1= case_when(is.na(Street_Number)~"Skipped Street Number"))
...
dt_home3skip_summary[2,1] <- "Skipped Street Name" 
dt_home3skip_summary[2,2] <- sum(is.na(home3skip$Street_Name))
dt_home3skip_summary[2,3] <- (sum(is.na(home3skip$Street_Name))/dim(home3skip)[[1]])*100

dt_home3skip_summary[3,1] <- "Skipped City"
dt_home3skip_summary[3,2] <- sum(is.na(home3skip$City))
dt_home3skip_summary[3,3] <- (sum(is.na(home3skip$City))/dim(home3skip)[[1]])*100

dt_home3skip_summary[4,1] <- "Skipped State"
dt_home3skip_summary[4,2] <- sum(is.na(home3skip$State))
dt_home3skip_summary[4,3] <- (sum(is.na(home3skip$State))/dim(home3skip)[[1]])*100

dt_home3skip_summary[5,1] <- "Skipped ZIP"
dt_home3skip_summary[5,2] <- sum(is.na(home3skip$ZIP))
dt_home3skip_summary[5,3] <- (sum(is.na(home3skip$ZIP))/dim(home3skip)[[1]])*100
...
dt_home3skip_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
Followup3_skip= home3 %>%  filter(home3$D_752101258_D_752101258!="[178420302]") %>% 
  mutate(Address= case_when(is.na(D_752101258_D_648495207) & is.na(D_828086036_D_588699608)~"Skipped City Follow-up"))
...
Followup3__skip[2,1] <- "Skipped State Follow-up" 
Followup3__skip[2,2] <- sum(is.na(Followup3_skip$D_752101258_D_300933270) & is.na(Followup3_skip$D_828086036_D_544692849))
Followup3__skip[2,3] <- (sum(is.na(Followup3_skip$D_752101258_D_300933270) & is.na(Followup3_skip$D_828086036_D_544692849))/dim(Followup3_skip)[[1]])*100

Followup3__skip[3,1] <- "Skipped ZIP Follow-up"
Followup3__skip[3,2] <- sum(is.na(Followup3_skip$D_752101258_D_649864362) & is.na(Followup3_skip$D_828086036_D_335435992))
Followup3__skip[3,3] <- (sum(is.na(Followup3_skip$D_752101258_D_649864362) & is.na(Followup3_skip$D_828086036_D_335435992))/dim(Followup3_skip)[[1]])*100

Followup3__skip[4,1] <- "Skipped Country Follow-up"
Followup3__skip[4,2] <- sum(is.na(Followup3_skip$D_752101258_D_723108194) & is.na(Followup3_skip$D_828086036_D_337088272))
Followup3__skip[4,3] <- (sum(is.na(Followup3_skip$D_752101258_D_723108194) & is.na(Followup3_skip$D_828086036_D_337088272))/dim(Followup3_skip)[[1]])*100


Followup3__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home_add3_3= home3 %>% #select(D_804504024_D_105043152, D_804504024_D_543135391) %>% 
  filter(home3$D_961572487_D_961572487!="[178420302]" & 
...
dt_home_add3_3 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addoth3 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addsum3 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home4skip= home4 %>%  mutate(Address1= case_when(is.na(Street_Number)~"Skipped Street Number"))
...
dt_home4skip_summary[2,1] <- "Skipped Street Name" 
dt_home4skip_summary[2,2] <- sum(is.na(home4skip$Street_Name))
dt_home4skip_summary[2,3] <- (sum(is.na(home4skip$Street_Name))/dim(home4skip)[[1]])*100

dt_home4skip_summary[3,1] <- "Skipped City"
dt_home4skip_summary[3,2] <- sum(is.na(home4skip$City))
dt_home4skip_summary[3,3] <- (sum(is.na(home4skip$City))/dim(home4skip)[[1]])*100

dt_home4skip_summary[4,1] <- "Skipped State"
dt_home4skip_summary[4,2] <- sum(is.na(home4skip$State))
dt_home4skip_summary[4,3] <- (sum(is.na(home4skip$State))/dim(home4skip)[[1]])*100

dt_home4skip_summary[5,1] <- "Skipped ZIP"
dt_home4skip_summary[5,2] <- sum(is.na(home4skip$ZIP))
dt_home4skip_summary[5,3] <- (sum(is.na(home4skip$ZIP))/dim(home4skip)[[1]])*100

dt_home4skip_summary[6,1] <- "Skipped Country"
dt_home4skip_summary[6,2] <- sum(is.na(home4skip$Country))
dt_home4skip_summary[6,3] <- (sum(is.na(home4skip$Country))/dim(home4skip)[[1]])*100

dt_home4skip_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
Followup4__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home_add3_4= home4 %>% #select(D_804504024_D_105043152, D_804504024_D_543135391) %>% 
  filter(home4$D_746604821_D_746604821!="[178420302]" & 
...
dt_home_add3_4 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addoth4 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addsum4 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home5skip= home5 %>%  mutate(Address1= case_when(is.na(Street_Number)~"Skipped Street Number"))
...
dt_home5skip_summary[2,1] <- "Skipped Street Name" 
dt_home5skip_summary[2,2] <- sum(is.na(home5skip$Street_Name))
dt_home5skip_summary[2,3] <- (sum(is.na(home5skip$Street_Name))/dim(home5skip)[[1]])*100

dt_home5skip_summary[3,1] <- "Skipped City"
dt_home5skip_summary[3,2] <- sum(is.na(home5skip$City))
dt_home5skip_summary[3,3] <- (sum(is.na(home5skip$City))/dim(home5skip)[[1]])*100

dt_home5skip_summary[4,1] <- "Skipped State"
dt_home5skip_summary[4,2] <- sum(is.na(home5skip$State))
dt_home5skip_summary[4,3] <- (sum(is.na(home5skip$State))/dim(home5skip)[[1]])*100

dt_home5skip_summary[5,1] <- "Skipped ZIP"
dt_home5skip_summary[5,2] <- sum(is.na(home5skip$ZIP))
dt_home5skip_summary[5,3] <- (sum(is.na(home5skip$ZIP))/dim(home5skip)[[1]])*100

dt_home5skip_summary[6,1] <- "Skipped Country"
dt_home5skip_summary[6,2] <- sum(is.na(home5skip$Country))
dt_home5skip_summary[6,3] <- (sum(is.na(home5skip$Country))/dim(home5skip)[[1]])*100

dt_home5skip_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
Followup5__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_add3_5 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addoth6 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_addsum5 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home6skip_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
Followup6__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home_add3_6 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
home_addsum6 <- home6 %>% filter(home6$d_452942800>=as.Date("2022-12-14") & (home6$D_135207939==104430631 | is.na(home6$D_135207939))) %>%  
...
dt_home_addsum6 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
#HOME1
home1_inout= Mod4 %>%  mutate(Answer= case_when(is.na(D_590222838)~"Skipped Home 1 Move-In Year"))
...
dt_home1_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Home 1 Move-In & Move-Out")) %>% 
  cols_label(n= md("**Number of Participants**"),Answer = md("**Question**"), percentage = md("**Percentage of Participants**")) %>% 
  #grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
  tab_options(
      stub.font.weight = "bold"
    ) %>%
...
dt_home2_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home3_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home4_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home5_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home6_inout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Home 5 Move-In & Move-Out")) %>% 
  cols_label(n= md("**Number of Participants**"),Answer = md("**Question**"), percentage = md("**Percentage of Participants**")) %>% 
  #grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
...
dt_home1_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home2_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home3_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home4_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home5_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_home6_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_sea_home_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_seahome_add1_1_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
FollowupV1__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_seaaddoth_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_seaaddsum1_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_SEASADDYRS_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_seahome_water_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
childhome= Mod4 %>%  filter(Mod4$D_277348878==751569137) %>% 
  mutate(Address1= case_when(is.na(D_632533534_D_284547539)~"Skipped Street Number"))
...
dt_childhome_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
FollowupC1__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
child_add3_1__skip %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_childinout_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_childwater_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_adultwater_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_adultwater2_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_work19_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_days_work19_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_commute_num_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork= Mod4 %>%  filter(Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360)) %>%  
  mutate(Address1= case_when(is.na(D_596318751_D_411791779) ~"Skipped Employer Name"))
...
dt_curwork_summary[2,1] <- "Skipped Employer Street Number" 
dt_curwork_summary[2,2] <- sum(is.na(curwork$D_596318751_D_493984171))
dt_curwork_summary[2,3] <- (sum(is.na(curwork$D_596318751_D_493984171))/dim(curwork)[[1]])*100

dt_curwork_summary[3,1] <- "Skipped Employer Street Name" 
dt_curwork_summary[3,2] <- sum(is.na(curwork$D_596318751_D_253017624))
dt_curwork_summary[3,3] <- (sum(is.na(curwork$D_596318751_D_253017624))/dim(curwork)[[1]])*100

dt_curwork_summary[4,1] <- "Skipped Employer City" 
dt_curwork_summary[4,2] <- sum(is.na(curwork$D_596318751_D_959804472))
dt_curwork_summary[4,3] <- (sum(is.na(curwork$D_596318751_D_959804472))/dim(curwork)[[1]])*100

dt_curwork_summary[5,1] <- "Skipped Employer State" 
dt_curwork_summary[5,2] <- sum(is.na(curwork$D_596318751_D_774707280))
dt_curwork_summary[5,3] <- (sum(is.na(curwork$D_596318751_D_774707280))/dim(curwork)[[1]])*100

dt_curwork_summary[6,1] <- "Skipped Employer ZIP" 
dt_curwork_summary[6,2] <- sum(is.na(curwork$D_596318751_D_182144476 ))
dt_curwork_summary[6,3] <- (sum(is.na(curwork$D_596318751_D_182144476 ))/dim(curwork)[[1]])*100

dt_curwork_summary[7,1] <- "Skipped Employer Country" 
dt_curwork_summary[7,2] <- sum(is.na(curwork$D_596318751_D_294634899))
dt_curwork_summary[7,3] <- (sum(is.na(curwork$D_596318751_D_294634899))/dim(curwork)[[1]])*100



dt_curwork_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT1_summary[8,2] <- sum(is.na(CURWORKT1$D_635467479_D_635467479_D_509121242) & is.na(CURWORKT1$D_635467479_D_635467479_D_902077989))
dt_CURWORKT1_summary[8,3] <- (sum(is.na(CURWORKT1$D_635467479_D_635467479_D_509121242) & is.na(CURWORKT1$D_635467479_D_635467479_D_902077989))/dim(CURWORKT1)[[1]])*100


dt_CURWORKT1_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
method <- CURWORKT2A_H %>% filter(D_635467479_D_635467479_D_902077989==1)
...
CURWORKT3_4_5= Mod4 %>%  filter( Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360) &
...
dt_CURWORKT3_4_5_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
CURWORKT6_summary <- Mod4 %>% filter(Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360)) %>% 
...
CURWORKT6 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
CURWORKT7_summary <- Mod4 %>% filter(Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360)) %>% 
...
CURWORKT7 %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT9_summary[8,2] <- sum(is.na(CURWORKT9$D_404697804_D_404697804_D_244488084) & is.na(CURWORKT9$D_404697804_D_404697804_D_631088397))
dt_CURWORKT9_summary[8,3] <- (sum(is.na(CURWORKT9$D_404697804_D_404697804_D_244488084) & is.na(CURWORKT9$D_404697804_D_404697804_D_631088397))/dim(CURWORKT9)[[1]])*100


dt_CURWORKT9_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10A_summary <- dt_CURWORKT10A_summary[1,]

dt_CURWORKT10A_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10B_summary <- dt_CURWORKT10B_summary[1,]

dt_CURWORKT10B_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10C_summary <- dt_CURWORKT10C_summary[1,]

# dt_CURWORKT10C_summary %>%  gt() %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10D_summary <- dt_CURWORKT10D_summary[1,]

dt_CURWORKT10D_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10E_summary <- dt_CURWORKT10E_summary[1,]

dt_CURWORKT10E_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURWORKT10F_summary <- dt_CURWORKT10F_summary[1,]

dt_CURWORKT10F_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_curworkT11_12_13_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
PREWORKRES= Mod4 %>%filter(Mod4$D_995620555==353358909) %>%  mutate(Address1= case_when(is.na(D_980007418) ~"Skipped PREWORKRES"))
...
dt_PREWORK1B_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_PREWORK2_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_PREWORK3_1_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_PREWORKYR1_2_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_PREWORKT1_summary[8,2] <- sum(is.na(PREWORKT1$D_311891586_D_311891586_D_766970054) & is.na(PREWORKT1$D_311891586_D_311891586_D_886203785))
dt_PREWORKT1_summary[8,3] <- (sum(is.na(PREWORKT1$D_311891586_D_311891586_D_766970054) & is.na(PREWORKT1$D_311891586_D_311891586_D_886203785))/dim(PREWORKT1)[[1]])*100


dt_PREWORKT1_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_PREWORKT6_summary[8,2] <- sum(is.na(PREWORKT6$D_251048648_D_251048648_D_572643998) & is.na(PREWORKT6$D_251048648_D_251048648_D_158678876))
dt_PREWORKT6_summary[8,3] <- (sum(is.na(PREWORKT6$D_251048648_D_251048648_D_572643998) & is.na(PREWORKT6$D_251048648_D_251048648_D_158678876))/dim(PREWORKT6)[[1]])*100


dt_PREWORKT6_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_stu_addressFU_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURSCH3_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURSCHYR1_summary %>%  gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
dt_CURSCHT1_summary[8,2] <- sum(is.na(CURSCHT1$D_404863614_D_404863614_D_211269389) & is.na(CURSCHT1$D_404863614_D_404863614_D_255860829))
dt_CURSCHT1_summary[8,3] <- (sum(is.na(CURSCHT1$D_404863614_D_404863614_D_211269389) & is.na(CURSCHT1$D_404863614_D_404863614_D_255860829))/dim(CURSCHT1)[[1]])*100


dt_CURSCHT1_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
CURSCHT7= STU %>%  filter(STU$D_449752653==353358909) %>%  
...
CURSCHT9= STU %>% filter(STU$D_449752653==353358909 & STU$D_496801729!=353358909) %>% 
  mutate(Address1= case_when(is.na(D_345355061_D_467242967) ~"Skipped if Commute Inlcudes a Car"))
...
dt_CURSCHT9_summary[2,2] <- sum(is.na(CURSCHT9$D_345355061_D_645051966))
dt_CURSCHT9_summary[2,3] <- (sum(is.na(CURSCHT9$D_345355061_D_645051966))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[3,1] <- "Skipped if Commute Inlcudes a Motorcycle" 
dt_CURSCHT9_summary[3,2] <- sum(is.na(CURSCHT9$D_345355061_D_756061540))
dt_CURSCHT9_summary[3,3] <- (sum(is.na(CURSCHT9$D_345355061_D_756061540))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[4,1] <- "Skipped if Commute Inlcudes a Bus" 
dt_CURSCHT9_summary[4,2] <- sum(is.na(CURSCHT9$D_345355061_D_198883577))
dt_CURSCHT9_summary[4,3] <- (sum(is.na(CURSCHT9$D_345355061_D_198883577))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[5,1] <- "Skipped if Commute Inlcudes a Subway" 
dt_CURSCHT9_summary[5,2] <- sum(is.na(CURSCHT9$D_345355061_D_634680635))
dt_CURSCHT9_summary[5,3] <- (sum(is.na(CURSCHT9$D_345355061_D_634680635))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[6,1] <- "Skipped if Commute Inlcudes Biking" 
dt_CURSCHT9_summary[6,2] <- sum(is.na(CURSCHT9$D_345355061_D_790657437))
dt_CURSCHT9_summary[6,3] <- (sum(is.na(CURSCHT9$D_345355061_D_790657437))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[7,1] <- "Skipped if Commute Inlcudes Walking" 
dt_CURSCHT9_summary[7,2] <- sum(is.na(CURSCHT9$D_345355061_D_107428524))
dt_CURSCHT9_summary[7,3] <- (sum(is.na(CURSCHT9$D_345355061_D_107428524))/dim(CURSCHT9)[[1]])*100

dt_CURSCHT9_summary[8,1] <- "Skipped if Commute Inlcudes Another Method" 
dt_CURSCHT9_summary[8,2] <- sum(is.na(CURSCHT9$D_345355061_D_804918983) & is.na(CURSCHT9$D_345355061_D_656067463))
dt_CURSCHT9_summary[8,3] <- (sum(is.na(CURSCHT9$D_345355061_D_804918983) & is.na(CURSCHT9$D_345355061_D_656067463))/dim(CURSCHT9)[[1]])*100


dt_CURSCHT9_summary %>%  gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Commuting Methods to School")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**Percentage of Participants**")) %>% 
  #grand_summary_rows(columns=c(n, percentage),fns = ~sum(.,na.rm = T))|>
...
#                                                                   ifelse(STU$D_496801729==104430631, STU$D_345355061_D_467242967==1,
#                                                                          ifelse(is.na(STU$D_496801729), STU$D_345355061_D_467242967==1,
...
CURSCHT14= STU %>% filter(STU$D_449752653==353358909) %>%   

...
d_827220437, state_d_706256705, state_d_934298480, d_142654897_d_177402915, d_142654897_d_196856782, d_142654897_d_206879104, d_142654897_d_241590841, d_142654897_d_285130077, d_142654897_d_326825649, d_142654897_d_461488577, d_142654897_d_462314689, d_142654897_d_520301146, d_142654897_d_549687190, d_142654897_d_607081902, d_142654897_d_639721694, d_142654897_d_642287621, d_142654897_d_684726272, d_142654897_d_791389099, d_142654897_d_819377306, d_142654897_d_829269606, d_142654897_d_942255248, d_142654897_d_967372009, d_335767902, d_914594314, state_d_849518448, state_d_706256705, d_949302066
 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP` where d_919254129= '353358909'"
...
proposal_aleah <- proposal_aleah %>%  mutate(marketing = case_when((d_142654897_d_461488577==353358909 | d_142654897_d_607081902==353358909 |
                                                                   ...
                                                                   d_142654897_d_462314689==353358909 ~ "Other",
                                                             TRUE ~ "Skipped")) %>%  filter(marketing!="Skipped")

proposal_aleah$marketing <- factor(proposal_aleah$marketing,levels=c("Digital","Traditional","Other"))
...
```{r test_chi, warning=FALSE, echo=FALSE, message=FALSE, include=FALSE}


## All significant 
age_chi <- chisq.test(table(proposal_aleah$Age, proposal_aleah$marketing))
race_chi <- chisq.test(table(proposal_aleah$Race, proposal_aleah$marketing))
sex_chi <- chisq.test(table(proposal_aleah$Sex, proposal_aleah$marketing))
inc_chi <- chisq.test(table(proposal_aleah$Income, proposal_aleah$marketing))
ed_chi <- chisq.test(table(proposal_aleah$Education, proposal_aleah$marketing))
site_chi <- chisq.test(table(proposal_aleah$Site, proposal_aleah$marketing))

if (age_chi$p.value < 0.05) {
  cat("With a p-value of", age_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by age.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by age.") }


if (race_chi$p.value < 0.05) {
  cat("With a p-value of", race_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by race.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by race.") }


if (sex_chi$p.value < 0.05) {
  cat("With a p-value of", sex_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by sex.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by sex.") }


if (inc_chi$p.value < 0.05) {
  cat("With a p-value of", inc_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by income level.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by income level.") }


if (ed_chi$p.value < 0.05) {
  cat("With a p-value of", ed_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by education level.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by education level.") }



if (site_chi$p.value < 0.05) {
  cat("With a p-value of", site_chi$p.value, "we have evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by site.")
} else {
  cat("With a p-value over 0.05, we have not evidence that there is a signifiance in the \n difference of digital marketing success and traditional marketing success by site.") }
...
site_demographics <- site_demographics %>%  mutate(marketing = case_when((d_142654897_d_461488577==353358909 | d_142654897_d_607081902==353358909 |
                                                                   ...
                                                                   d_142654897_d_462314689==353358909 ~ "Other",
                                                             TRUE ~ "Skipped")) %>%  filter(marketing!="Skipped")
site_demographics$marketing <- factor(site_demographics$marketing,levels=c("Digital","Traditional","Other"))
...
```{r site_test_chi, warning=FALSE, echo=FALSE, message=FALSE, include=FALSE}


## All significant 
age_chi <- chisq.test(table(site_demographics$Age, site_demographics$marketing))
race_chi <- chisq.test(table(site_demographics$Race, site_demographics$marketing))
sex_chi <- chisq.test(table(site_demographics$Sex, site_demographics$marketing))
site_chi <- chisq.test(table(site_demographics$Site, site_demographics$marketing))
...
\newpage
```{r site_tables_loops, warning=FALSE, echo=FALSE, message=FALSE, include=FALSE}
...
for (demo in demographics) {
  ...
  # Insert LaTeX command for float barrier
  cat("\\FloatBarrier\n")
  
  # Perform Chi-squared test
  chi <- chisq.test(table(site_demographics[[demo]], site_demographics$marketing))
  if (chi$p.value < 0.05) {
    cat("With a p-value of", chi$p.value, "we have evidence that there is a significance in the difference of digital marketing success and traditional marketing success by", demo, ".\\newpage")
  } else {
    cat("With a p-value over 0.05, we have not evidence that there is a significance in the difference of digital marketing success and traditional marketing success by", demo, ".\\newpage")
  }

...
\FloatBarrier
```{r Table4_trends2, include=FALSE}
...
knitr::kable(QOL_TM_table, #format.args = list(big.mark = ","),
             caption = 'Table 13. 3-Month Quality of Life Survey Completion Time from Start to Submit \n Among Eligible Participants', 
...
all_data %>% tbl_cross(
    ...
    margin_text="Total") %>% 
  modify_header(stat_0 = "Total") %>%
  modify_caption("Table 15. Preferred Language by Site") %>%
  as_kable_extra(escape = FALSE, addtl_fmt = TRUE) %>%  
...
consist <- knitr::kable(scenario_counts,
                        caption = "Table 16. Consistency of Language Choice in Survey Completion",
...
knitr::kable(BL_lang_E, format.args = list(big.mark = ","), digits=2, 
             caption='18.a. Time (in minutes) from Start to Submit of Initial Survey Modules for English',
             row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c"), booktabs = TRUE)%>% 
    kable_styling(latex_options = c("scale_down","hold_position")) 

knitr::kable(BL_lang_SP, format.args = list(big.mark = ","), digits=2, 
             caption='Table 18.b. Time (in minutes) from Start to Submit of Initial Survey Modules for Spanish',
             row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c"),booktabs = TRUE)%>% 
    kable_styling(latex_options = c("scale_down","hold_position")) 

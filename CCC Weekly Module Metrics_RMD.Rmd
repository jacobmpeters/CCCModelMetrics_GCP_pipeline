...
query="SELECT distinct(token), min(notification_time) as BU_time #account for duplicate notifications
...
query="SELECT distinct(token), min(notification_time) as BUM_time #account for duplicate notifications
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications_JP`
...
#BUM/BU/MW- when notified by email 
